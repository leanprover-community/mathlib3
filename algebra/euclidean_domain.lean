...
instance  euclidean_domain.has_decidable_eq [euclidean_domain α] (a b : α) : decidable (a = b) :=
euclidean_domain.decidable_eq a b
...
def gcd [euclidean_domain α] : α → α → α
