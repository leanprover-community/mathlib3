...
continuous_iff_continuous_at.trans $ forall_congr $ λ b, tendsto_nhds_of_metric
...
continuous_iff_continuous_at.trans $ forall_congr $ λ b, tendsto_nhds_topo_metric
