...
begin
  ...
  { have xyz_ineq := mul_nonneg xy_ineq z_ineq,
    ...
    norm_num at ineq1,
    rw [←mul_rpow x_ineq y_ineq, ←mul_rpow xy_ineq z_ineq,
      ←rpow_le_rpow_iff (rpow_nonneg_of_nonneg xyz_ineq _) ineq' ineq''',
      ←rpow_mul xyz_ineq] at ineq1,
    norm_num at ineq1,
    have ineq2 := add_le_add (mul_le_mul (le_refl (1/4 : ℝ)) ineq1 xyz_ineq ineq'') (le_refl (1/4)),
