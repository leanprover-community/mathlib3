...
-- instance : has_mem α (finset α) := ⟨mem⟩  -- this causes a failure of type class inference
infix ∈ := mem
   ...
   (λ l,
    list.rec_on l
      ...
      (λ a l',
        ...
        have p : P (insert a (quot.mk _ (subtype.mk l' _))), from H2 this p1,
...
ext (λ x, by rw [mem_inter_eq];repeat {rw mem_union_eq};repeat {rw mem_inter_eq}; apply iff.intro; repeat {finish})
