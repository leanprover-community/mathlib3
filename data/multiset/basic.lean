...
by rw ← subset_zero_iff; simp [subset_iff, disjoint]
...
theorem nodup_inter_of_nodup [decidable_eq α] {s : multiset α} (t) : nodup s → nodup (s ∩ t) :=
...
quotient.induction_on₂ s t $ λ l₁ l₂, nodup_union _
