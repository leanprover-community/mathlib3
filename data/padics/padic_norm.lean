...
/--
  Ideally, this should not depend on hp. However, in order to instantiate is_absolute_value, we
  need that p is prime. So we need either a [is_prime] typeclass or this argument.
-/
...
begin
    ...
    exact nonarchimedean_aux hp hle
end
