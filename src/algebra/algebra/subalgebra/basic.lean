...
instance to_ordered_cancel_semiring {R A}
  [comm_semiring R] [ordered_cancel_semiring A] [algebra R A] (S : subalgebra R A) :
  ordered_cancel_semiring S := S.to_subsemiring.to_ordered_cancel_semiring
...
instance to_ordered_cancel_comm_semiring {R A}
  [comm_semiring R] [ordered_cancel_comm_semiring A] [algebra R A] (S : subalgebra R A) :
  ordered_cancel_comm_semiring S := S.to_subsemiring.to_ordered_cancel_comm_semiring
