...
-/
lemma sum_range_sub_of_monotone [ordered_addcomm_monoid α] [canonical_mul_order α] [has_sub α]
  [has_ordered_sub α] [contravariant_class α α (+) (≤)] {f : ℕ → α} (h : monotone f) (n : ℕ) :
  ∑ i in range n, (f (i+1) - f i) = f n - f 0 :=
begin
