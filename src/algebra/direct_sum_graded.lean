...
begin
  ...
  A : ι → Type u_2,
  _inst_2 : Π (i : ι), add_comm_monoid (A i),
  _inst_3 : add_monoid ι,
  _inst_4 : gmonoid A,
  a b c : ⨁ (i : ι), A i
  ⊢ (⇑add_monoid_hom.comp_hom (mul_hom A)).comp (mul_hom A) =
      (⇑(⇑add_monoid_hom.comp_hom flip_hom) ((⇑add_monoid_hom.comp_hom (mul_hom A).flip).comp (mul_hom A))).flip
  -/
  ...
  ci : ι,
  cx : A ci
  ⊢ ⇑(⇑(⇑((⇑add_monoid_hom.comp_hom (mul_hom A)).comp (mul_hom A)) (⇑(of (λ (i : ι), A i) ai) ax))
           (⇑(of (λ (i : ι), A i) bi) bx))
        (⇑(of (λ (i : ι), A i) ci) cx) =
      ⇑(⇑(⇑((⇑(⇑add_monoid_hom.comp_hom flip_hom)
  ...
  -- simp only [coe_comp, function.comp_app],
  ...
  ci : ι,
  cx : A ci
  ⊢ ⇑(⇑(⇑(⇑add_monoid_hom.comp_hom (mul_hom A)) (⇑(mul_hom A) (⇑(of (λ (i : ι), A i) ai) ax)))
           (⇑(of (λ (i : ι), A i) bi) bx))
        (⇑(of (λ (i : ι), A i) ci) cx) =
      ⇑(⇑(⇑((⇑(⇑add_monoid_hom.comp_hom flip_hom)
                  ((⇑add_monoid_hom.comp_hom (mul_hom A).flip).comp (mul_hom A))).flip)
  ...
  ci : ι,
  cx : A ci
  ⊢ ⇑((⇑((⇑(((⇑add_monoid_hom.comp_hom (mul_hom A)).comp (mul_hom A)).comp (of (λ (i : ι), A i) ai)) ax).comp
               (of (λ (i : ι), A i) bi))
            bx).comp
           (of (λ (i : ι), A i) ci))
        cx =
  ...
  cx : A ci,
  i : ι
  ⊢ ⇑(⇑((⇑((⇑(((⇑add_monoid_hom.comp_hom (mul_hom A)).comp (mul_hom A)).comp (of (λ (i : ι), A i) ai))
                   ax).comp
                  (of (λ (i : ι), A i) bi))
               bx).comp
              (of (λ (i : ι), A i) ci))
  ...
  rw [comp_hom_apply_apply, coe_comp, function.comp_app],
  -- simplify rhs
