...
instance is_domain.to_no_zero_divisors [mul_zero_class R] [is_domain R] :
  no_zero_divisors R :=
⟨λ a b h, or_iff_not_and_not.mpr $
  λ H, H.right $ mul_left_cancel_of_ne_zero H.left $ (mul_zero a).symm ▸ h⟩

@[priority 100] -- see Note [lower instance priority]
instance is_domain.to_cancel_monoid_with_zero [monoid_with_zero R] [is_domain R] :
...
@[priority 100] -- see Note [lower instance priority]
instance is_domain.to_cancel_comm_monoid_with_zero [comm_monoid_with_zero R] [is_domain R] :
