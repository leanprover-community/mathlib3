...
See note [reducible non-instances]. -/
@[reducible]
protected def add_monoid_with_one {M₁} [has_zero M₁] [has_one M₁] [has_add M₁] [has_scalar ℕ M₁]
...
protected def add_group_with_one {M₁} [has_zero M₁] [has_one M₁] [has_add M₁] [has_scalar ℕ M₁]
  [has_neg M₁] [has_sub M₁] [has_scalar ℤ M₁]
...
{ .. hf.add_group f zero add neg sub nsmul zsmul,
  .. hf.add_monoid_with_one f zero add nsmul }
