...
addition by `g` and `-g` on the left. For subgroups generated by more than one element, see
...
@[to_additive "To show a property of all multiples of `g` it suffices to show it is closed under
addition by `g` and `-g` on the right. For subgroups generated by more than one element, see
