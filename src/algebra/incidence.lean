...
section lambda
variables (𝕜) [has_zero 𝕜] [has_one 𝕜] [preorder α] [decidable_eq α] [@decidable_rel α (⩿)]
...
variables {𝕜} [locally_finite_order α] [locally_finite_order β] (f f₁ f₂ : incidence_algebra 𝕜 α)
  (g g₁ g₂ : incidence_algebra 𝕜 β)
