...
{ commL1R1 := begin
    ...
    ext b,
    rw ring.lie_def,
    simp only [add_monoid_hom.coe_mul_right, add_monoid_hom.zero_apply, add_monoid_hom.sub_apply, function.comp_app, R_apply,
  ...
  commL1L2 := begin
    ...
    ext b,
    rw ring.lie_def,
    simp only [add_monoid_hom.zero_apply, add_monoid_hom.sub_apply, function.comp_app, add_monoid.coe_mul, L_apply_apply],
