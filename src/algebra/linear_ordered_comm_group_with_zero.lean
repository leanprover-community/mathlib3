...
begin
  ...
  exact
    @div_le_div_iff' _ _ _ _ (units.mk0 a ha) (units.mk0 b hb) (units.mk0 c hc) (units.mk0 d hd)
end
...
@mul_lt_mul''' _
  (units.mk0 a ha) (units.mk0 b hb) (units.mk0 c hc) (units.mk0 d hd) _ _ _ _ hab hcd
...
@inv_lt_inv_iff _ _ _ _ _ (units.mk0 b hb) (units.mk0 a ha)

lemma inv_le_inv'' (ha : a ≠ 0) (hb : b ≠ 0) : a⁻¹ ≤ b⁻¹ ↔ b ≤ a :=
@inv_le_inv_iff _ _ _ _ _ (units.mk0 b hb) (units.mk0 a ha)
