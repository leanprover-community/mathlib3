...
lemma mul_lt_mul_of_le_of_lt [pos_mul_strict_mono α] [mul_pos_mono α]
  (a0 : 0 < a) (d0 : 0 ≤ d) (h₁ : a ≤ b) (h₂ : c < d) : a * c < b * d :=
(mul_lt_mul_left' a0 h₂).trans_le (mul_le_mul_of_nonneg_right d0 h₁)

lemma mul_lt_mul_of_le_of_lt' [pos_mul_strict_mono α] [mul_pos_mono α]
  (c0 : 0 ≤ c) (b0 : 0 < b) (h₁ : a ≤ b) (h₂ : c < d) : a * c < b * d :=
(mul_le_mul_of_nonneg_right c0 h₁).trans_lt (mul_lt_mul_left' b0 h₂)

lemma mul_lt_mul_of_lt_of_le [pos_mul_mono α] [mul_pos_strict_mono α]
  (a0 : 0 ≤ a) (d0 : 0 < d) (h₁ : a < b) (h₂ : c ≤ d) : a * c < b * d :=
(mul_le_mul_of_nonneg_left a0 h₂).trans_lt (mul_lt_mul_right' d0 h₁)

lemma mul_lt_mul_of_lt_of_le' [pos_mul_mono α] [mul_pos_strict_mono α]
  (c0 : 0 < c) (b0 : 0 ≤ b) (h₁ : a < b) (h₂ : c ≤ d) : a * c < b * d :=
(mul_lt_mul_right' c0 h₁).trans_le (mul_le_mul_of_nonneg_left b0 h₂)
...
mul_lt_mul_of_le_of_lt' c0 (a0.trans_lt h₁) h₁.le h₂
