...
instance [has_nat_cast α] : has_nat_cast (with_top α) :=
...
{ right_distrib   := distrib',
  ...
  .. with_top.has_nat_cast, .. with_top.add_comm_monoid, .. with_top.comm_monoid_with_zero }
...
instance [has_nat_cast α] : has_nat_cast (with_bot α) :=
