...
@[to_additive]
instance ordered_comm_group.to_covariant_class_left_lt (α : Type u) [ordered_comm_group α] :
  covariant_class α α (*) (<) :=
{ covc := λ a b c bc, mul_lt_mul_left' bc a }
...
lt_sub_iff_add_lt.trans neg_add_lt_iff_lt_add'
