...
{ r := eqv_gen (rel r),
  ...
  add' := λ a b c d hab hcd, begin
    ...
    { induction hcd with c' d' hcd f c' d' hcd' habcd' c' d' f' hcd' hdf' hbcd' hbcf',
      ...
      exact hbcd'.trans _ _ _ hbcf' },
    { refine (hab_ih _ _ $ hcd.symm _ _).symm _ _, },
    { refine (ihcd' _ _ hcd).trans _ _ _ (ihde' _ _ $ eqv_gen.refl _), },
  end,
  mul' := λ a b c d hab hcd, begin
    dunfold setoid.r at ⊢ hab hcd,
    induction hab with a' b' hab e a' b' hab' _ c' d' e hcd' hde' ihcd' ihde' generalizing c d,
...
begin
  ...
  { intro h,
    ...
    { induction h₃₄ with _ dfg h₃₄ x₃ x₄ x₅ h₃₄',
      ...
      { exact h₃₄_ih.add _ _ _ _ (ring_con_gen.rel.refl _) },
      { exact h₃₄_ih.mul _ _ _ _ (ring_con_gen.rel.refl _) },
      { exact (ring_con_gen.rel.refl _).mul _ _ _ _ h₃₄_ih} },
    { exact ring_con_gen.rel.refl _ },
    { exact ring_con_gen.rel.symm _ _ ‹_› },
    { exact ring_con_gen.rel.trans _ _ _ ‹_› ‹_› } },
  { intro h,
    induction h,
    { exact eqv_gen.rel _ _ (rel.of ‹_›), },
    { exact eqv_gen.refl _, },
    { exact eqv_gen.symm _ _ ‹_›, },
    { exact eqv_gen.trans _ _ _ ‹_› ‹_›, },
    { refine (ring_quot.ring_con r).add' ‹_› ‹_›, },
    { refine (ring_quot.ring_con r).mul' ‹_› ‹_›, } }
end
