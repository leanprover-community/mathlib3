...
-/
def unitary (R : Type*) [monoid R] [star_magma R] : submonoid R :=
...
section monoid
variables [monoid R] [star_magma R]
...
section comm_monoid
variables [comm_monoid R] [star_magma R]
...
variables [group_with_zero R] [star_magma R]
