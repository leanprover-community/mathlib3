...
begin
  ...
  { norm_cast,
    ...
    { apply associates.irreducible v }}
end
...
begin
  ...
  simp [← ideal.one_eq_top, -subtype.val_eq_coe,
    associates.count_zero (associates.irreducible v)],
end
...
begin
  have hv : _root_.irreducible (associates.mk v.as_ideal) := associates.irreducible v,
