...
open category_theory algebraic_geometry category_theory.limits category_theory.over
...
local attribute [instance] construct_products.over_binary_product_of_pullback over_has_terminal
...
instance : has_finite_products (AlgSchemeOver k) := has_finite_products_of_has_binary_and_terminal
