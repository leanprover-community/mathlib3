...
/-!
# Absolute values and determinants

This file gives a bound on the determinant of a matrix,
in terms of the size and a bound on the entries of that matrix.
-/
