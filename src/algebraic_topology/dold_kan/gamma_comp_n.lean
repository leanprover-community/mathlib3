...
begin
  ...
  simp only [whiskering_left_obj_preimage_app, N₂Γ₂_to_karoubi_iso_inv, functor.id_map,
    ...
    homological_complex.comp_f, N₁Γ₀_inv_app_f_f, splitting.to_karoubi_nondeg_complex_iso_N₁_hom_f_f,
    Γ₂_map_f_app, karoubi.decomp_id_p_f, P_infty_on_Γ₀_splitting_summand_eq_self_assoc],
  dsimp [to_karoubi],
  rw [splitting.ι_desc],
