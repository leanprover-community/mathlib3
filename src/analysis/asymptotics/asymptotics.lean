...
variables [seminormed_add_group E'] [seminormed_add_group F'] [seminormed_add_group G']
variables [normed_add_group E''] [normed_add_group F''] [normed_add_group G'']
...
begin
  ...
  { unfold is_o, rintros ⟨φ, hφ, huvφ⟩ c hpos,
    rw normed_add_group.tendsto_nhds_zero at hφ,
...
lemma is_o.tendsto_zero_of_tendsto {α E 𝕜 : Type*} [normed_add_group E] [normed_field 𝕜] {u : α → E}
...
theorem is_O_with_pi {ι : Type*} [fintype ι] {E' : ι → Type*} [Π i, normed_add_group (E' i)]
...
@[simp] theorem is_O_pi {ι : Type*} [fintype ι] {E' : ι → Type*} [Π i, normed_add_group (E' i)]
  {f : α → Π i, E' i} :
...
lemma summable_of_is_O {ι E} [normed_add_group E] [complete_space E] {f : ι → E} {g : ι → ℝ}
...
lemma summable_of_is_O_nat {E} [normed_add_group E] [complete_space E] {f : ℕ → E} {g : ℕ → ℝ}
