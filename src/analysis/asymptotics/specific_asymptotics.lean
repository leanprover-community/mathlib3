...
lemma asymptotics.is_o.sum_range {α : Type*} [normed_add_group α]
...
lemma asymptotics.is_o_sum_range_of_tendsto_zero {α : Type*} [normed_add_group α]
...
lemma filter.tendsto.cesaro_smul {E : Type*} [normed_add_group E] [normed_space ℝ E]
