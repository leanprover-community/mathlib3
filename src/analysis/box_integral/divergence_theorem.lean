...
begin
  ...
  required estimate.  -/
  have Hl : I.lower i ∈ Icc (I.lower i) (I.upper i), from set.left_mem_Icc.2 (I.lower_le_upper i),
  have Hu : I.upper i ∈ Icc (I.lower i) (I.upper i), from set.right_mem_Icc.2 (I.lower_le_upper i),
...
begin
  ...
  { intros c x hx ε ε0,
    ...
    have Hl : J.lower i ∈ Icc (J.lower i) (J.upper i), from set.left_mem_Icc.2 (J.lower_le_upper i),
    have Hu : J.upper i ∈ Icc (J.lower i) (J.upper i), from set.right_mem_Icc.2 (J.lower_le_upper i),
