...
normed_add_group.to_add_comm_group normed_space.to_module' add_comm_group.to_add_comm_monoid
...
{X : Type*} [normed_add_group X] [normed_space 𝕜 X]
...
private lemma cont_diff_on.comp_same_univ
  {Eu : Type u} [normed_add_group Eu] [normed_space 𝕜 Eu]
  {Fu : Type u} [normed_add_group Fu] [normed_space 𝕜 Fu]
  {Gu : Type u} [normed_add_group Gu] [normed_space 𝕜 Gu]
...
variables [normed_add_group E₁] [normed_add_group E₂] [normed_add_group E₃] [normed_add_group E₄]
...
variables {ι ι' : Type*} [fintype ι] [fintype ι'] {F' : ι → Type*} [Π i, normed_add_group (F' i)]
...
lemma cont_diff_on.prod_map {E' : Type*} [normed_add_group E'] [normed_space 𝕜 E']
  {F' : Type*} [normed_add_group F'] [normed_space 𝕜 F']
...
variables
{𝕂 : Type*} [is_R_or_C 𝕂]
{E' : Type*} [normed_add_group E'] [normed_space 𝕂 E']
{F' : Type*} [normed_add_group F'] [normed_space 𝕂 F']
...
lemma has_ftaylor_series_up_to_on.exists_lipschitz_on_with_of_nnnorm_lt {E F : Type*}
  [normed_add_group E] [normed_space ℝ E] [normed_add_group F] [normed_space ℝ F] {f : E → F}
...
within `s`. -/
lemma cont_diff_within_at.exists_lipschitz_on_with {E F : Type*} [normed_add_group E]
  [normed_space ℝ E] [normed_add_group F] [normed_space ℝ F] {f : E → F} {s : set E}
