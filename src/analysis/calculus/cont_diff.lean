...
/- TODO porting note: move to the file `data.nat.choose.sum` -/
/-- The sum of `(n+1).choose i * a i * b (n+1-i)` can be split into two sums at rank `n`,
respectively of `n.choose i * a i * b (n+1-i)` and `n.choose i * a (i+1) * b (n-i)`. -/
