...
section
variables {F : Type v} [normed_add_group F] [normed_space 𝕜 F]
variables {E : Type w} [normed_add_group E] [normed_space 𝕜 E]
...
lemma deriv_within_Ioi_eq_Ici {E : Type*} [normed_add_group E] [normed_space ℝ E] (f : ℝ → E) (x : ℝ) :
...
variables {ι : Type*} [fintype ι] {E' : ι → Type*} [Π i, normed_add_group (E' i)]
...
variables {G : Type w} [normed_add_group G] [normed_space 𝕜 G]
variables {f₂ : 𝕜 → G} {f₂' : G}
...
variables {G : Type*} [normed_add_group G] [normed_space 𝕜 G] {c : 𝕜 → F →L[𝕜] G} {c' : F →L[𝕜] G}
...
variables {E : Type*} [normed_add_group E] [normed_space 𝕜 E] {x : 𝕜} {s : set 𝕜} {m : ℤ}
...
open function
variables {F : Type*} [normed_add_group F] [normed_space 𝕜 F] {f : 𝕜 → F}
...
variables {E : Type u} [normed_add_group E] [normed_space ℝ E] {f : ℝ → E} {f' : E} {s : set ℝ}
  {x r : ℝ}
