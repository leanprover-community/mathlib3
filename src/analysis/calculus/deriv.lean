...
theorem has_deriv_at.is_O_sub_rev (hf : has_deriv_at f f' x) (hf' : f' ≠ 0) :
  is_O (λ x', x' - x) (λ x', f x' - f x) (𝓝 x) :=
suffices antilipschitz_with ∥f'∥₊⁻¹ (smul_right (1 : 𝕜 →L[𝕜] 𝕜) f'),
  from hf.has_fderiv_at.is_O_sub_rev this,
