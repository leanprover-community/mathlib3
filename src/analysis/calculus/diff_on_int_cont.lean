...
variables (𝕜 : Type*) {E F G : Type*} [nondiscrete_normed_field 𝕜] [normed_add_group E]
  [normed_add_group F] [normed_space 𝕜 E] [normed_space 𝕜 F] [normed_add_group G] [normed_space 𝕜 G]
