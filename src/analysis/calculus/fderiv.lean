...
begin
  ...
  { convert is_open_empty,
    ext x,
    refine ⟨λ h', _, λ h', empty_subset _ h'⟩,
    obtain ⟨e, he⟩ := h',
    exfalso,
    exact not_nonempty_iff_imp_false.mp h e },
end
