...
variables {ι : Type*} [fintype ι] {F' : ι → Type*} [Π i, normed_add_group (F' i)]
...
variables {H : Type*} [normed_add_group H] [normed_space 𝕜 H] {c : E → G →L[𝕜] H}
...
variables (𝕜 : Type*) [nondiscrete_normed_field 𝕜]
variables {𝕜' : Type*} [nondiscrete_normed_field 𝕜'] [normed_algebra 𝕜 𝕜']
variables {E : Type*} [normed_add_group E] [normed_space 𝕜 E] [normed_space 𝕜' E]
variables [is_scalar_tower 𝕜 𝕜' E]
variables {F : Type*} [normed_add_group F] [normed_space 𝕜 F] [normed_space 𝕜' F]
...
variables [normed_add_group E] [normed_space 𝕜 E] [normed_add_group F] [normed_space 𝕜 F] {f : E → F}
