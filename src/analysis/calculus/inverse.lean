...
variables {E : Type*} [normed_add_group E] [normed_space 𝕜 E]
variables {F : Type*} [normed_add_group F] [normed_space 𝕜 F]
variables {G : Type*} [normed_add_group G] [normed_space 𝕜 G]
variables {G' : Type*} [normed_add_group G'] [normed_space 𝕜 G']
variables {ε : ℝ}
...
lemma exists_homeomorph_extension {E : Type*} [normed_add_group E] [normed_space ℝ E]
  {F : Type*} [normed_add_group F] [normed_space ℝ F] [finite_dimensional ℝ F]
...
variables {E' : Type*} [normed_add_group E'] [normed_space 𝕂 E']
variables {F' : Type*} [normed_add_group F'] [normed_space 𝕂 F']
