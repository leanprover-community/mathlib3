...
lemma continuous_abs : continuous complex.abs := continuous_norm

lemma continuous_norm_sq : continuous complex.norm_sq :=
by simpa [← complex.norm_sq_eq_abs] using complex.continuous_abs.pow 2
