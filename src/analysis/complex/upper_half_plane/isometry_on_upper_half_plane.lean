...
begin
  ...
  { simp only [coe_involute, subtype.coe_mk, im_involute_smul, im_mk, complex.dist_eq, complex.abs],
    ...
    simp only [complex.norm_sq_apply],
    simp only [complex.sub_re, complex.sub_im, complex.inv_re, complex.inv_im, complex.norm_sq_apply],
...
begin
  ...
  have h4 : (c : ℂ) * z + (d : ℂ) ≠ 0, have h4' := transform_denom_apply g z, rw [hg10, hg11] at h4', 
