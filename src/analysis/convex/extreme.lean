...
section has_scalar
variables [strict_ordered_add_cancel_semiring 𝕜] [add_comm_monoid E] [has_scalar 𝕜 E]
...
variables {𝕜} [strict_ordered_add_cancel_semiring 𝕜] [add_comm_group E] [module 𝕜 E] {A B : set E}
  {x : E}
