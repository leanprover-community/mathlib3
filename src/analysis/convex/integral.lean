...
for a finite sum version of this lemma. -/
lemma convex_on.map_smul_integral_le [is_finite_measure μ] {s : set E} {g : E → ℝ} (hg : convex_on s g)
...
lemma convex_on.map_integral_le [is_probability_measure μ] {s : set E} {g : E → ℝ} (hg : convex_on s g)
