...
class uniform_convex_space (E : Type*) [seminormed_add_group E] : Prop :=
...
variables (E) [seminormed_add_group E] [uniform_convex_space E] {ε : ℝ}
...
variables [normed_add_group E] [normed_space ℝ E] [uniform_convex_space E]
