...
variables [normed_add_group E] [normed_add_group E'] [normed_add_group E''] [normed_add_group F]
...
variables [seminormed_add_group G]
...
section assoc
variables [normed_add_group F'] [normed_space ℝ F'] [normed_space 𝕜 F'] [complete_space F']
variables [normed_add_group F''] [normed_space ℝ F''] [normed_space 𝕜 F''] [complete_space F'']
variables {k : G → E''}
...
variables [normed_add_group G] [borel_space G]
