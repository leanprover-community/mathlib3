...
begin
  ...
  have cpos : 0 < c,
  sorry { refine (integral_pos_iff_support_of_nonneg (λ x, (g_mem x).1) _).mpr _,
    { refine g_smooth.continuous.integrable_of_has_compact_support _,
