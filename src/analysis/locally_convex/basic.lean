...
lemma normed_space.absorbent_ball_zero {𝕜' : Type*} [normed_field 𝕜'] [seminormed_add_comm_group E]
  [normed_space 𝕜' E] {r : ℝ} (hr : 0 < r) :
  absorbent 𝕜' (metric.ball (0 : E) r) :=
begin
...
begin
  ...
  exact normed_space.absorbent_ball_zero hr
end
...
lemma normed_space.balanced_ball_zero {𝕜' : Type*} [normed_field 𝕜'] [seminormed_add_comm_group E]
  [normed_space 𝕜' E] (r : ℝ) :
...
lemma normed_space.balanced_closed_ball_zero {𝕜' : Type*} [normed_field 𝕜']
  [seminormed_add_comm_group E] [normed_space 𝕜' E] (r : ℝ) :
  balanced 𝕜' (metric.closed_ball (0 : E) r) :=
begin
  rw balanced_iff_smul_mem,
  intros a ha x hx,
