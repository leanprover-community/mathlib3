...
begin
  ...
  { simp [add_eq_zero_iff.mp h_zero, ennreal.zero_rpow_of_pos (lt_of_lt_of_le zero_lt_one hp1)], },
  ...
  have hab_0 : (a + b)^p ≠ 0, by simp [ha_top, hb_top, lt_of_lt_of_le zero_lt_one hp1, h_nonzero],
