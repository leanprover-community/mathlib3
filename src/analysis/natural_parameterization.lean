...
begin
  ...
  rw ←evariation_on.comp_eq_of_monotone_on (natural_parameterization f as) φ _ φmapsto φsurjon,
  { rw @evariation_on.eq_of_edist_zero_on _ _ _ _ _ f,
    { rw variation_on_from_to_eq_of_le _ _ ‹b≤c›,
      rw ennreal.of_real_to_real (hf b c bs cs), },
    { rintro x ⟨xs,bx,xc⟩,
      rw edist_comm,
      apply natural_parameterization_edist_zero hf as xs, }, },
  { apply φm.mono (set.inter_subset_left _ _), },
end
