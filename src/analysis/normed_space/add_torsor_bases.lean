...
lemma exists_subset_affine_independent_span_eq_top_of_open {u : set P} (hu : is_open u)
  (hne : u.nonempty) :
...
lemma is_open.affine_span_eq_top_of {u : set P} (hu : is_open u) (hne : u.nonempty) :
  affine_span ℝ u = ⊤ :=
let ⟨
...
begin
  ...
  { intros h,
    ...
    { rw [subtype.range_coe_subtype, set_of_mem_eq] at this,
      ...
      mono* },
    lift t to finset V using finite_set_of_fin_dim_affine_independent ℝ h_ind,
