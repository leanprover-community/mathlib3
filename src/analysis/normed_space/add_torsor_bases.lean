...
variables [normed_add_group E] [normed_space 𝕜 E] [finite_dimensional 𝕜 E]
...
lemma interior_convex_hull_aff_basis {ι E : Type*} [fintype ι] [normed_add_group E] [normed_space ℝ E]
...
variables {V P : Type*} [normed_add_group V] [normed_space ℝ V] [metric_space P] [normed_add_torsor V P]
include V
