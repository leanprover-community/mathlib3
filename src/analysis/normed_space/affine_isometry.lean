...
`seminormed_add_group` and specialize to `normed_add_group` only when needed.
...
variables (𝕜 : Type*) {V V₁ V₂ V₃ V₄ : Type*} {P₁ : Type*} (P P₂ : Type*) {P₃ P₄ : Type*}
    [normed_field 𝕜]
  [seminormed_add_group V] [seminormed_add_group V₁] [seminormed_add_group V₂] [seminormed_add_group V₃]
