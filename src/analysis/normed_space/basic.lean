...
Note that since this requires `seminormed_add_group` and not `normed_add_group`, this typeclass can be
used for "semi normed spaces" too, just as `module` can be used for "semi modules". -/
class normed_space (α : Type*) (β : Type*) [normed_field α] [seminormed_add_group β]
  extends module α β :=
(norm_smul_le : ∀ (a:α) (b:β), ∥a • b∥ ≤ ∥a∥ * ∥b∥)
end prio

variables [normed_field α] [seminormed_add_group β]
...
variables {E : Type*} [seminormed_add_group E] [normed_space α E]
variables {F : Type*} [seminormed_add_group F] [normed_space α F]
...
@[simps { attrs := [] }]
def homeomorph_unit_ball {E : Type*} [seminormed_add_group E] [normed_space ℝ E] :
  E ≃ₜ ball (0 : E) 1 :=
...
instance pi.normed_space {E : ι → Type*} [fintype ι] [∀i, seminormed_add_group (E i)]
...
instance submodule.normed_space {𝕜 R : Type*} [has_smul 𝕜 R] [normed_field 𝕜] [ring R]
  {E : Type*} [seminormed_add_group E] [normed_space 𝕜 E] [module R E]
...
variables {E : Type*} [normed_add_group E] [normed_space α E]
variables {F : Type*} [normed_add_group F] [normed_space α F]

open normed_field

/-- While this may appear identical to `normed_space.to_module`, it contains an implicit argument
involving `normed_add_group.to_seminormed_add_group` that typeclass inference has trouble inferring.

Specifically, the following instance cannot be found without this `normed_space.to_module'`:
```lean
example
  (𝕜 ι : Type*) (E : ι → Type*)
  [normed_field 𝕜] [Π i, normed_add_group (E i)] [Π i, normed_space 𝕜 (E i)] :
...
variables (𝕜 E : Type*) [nondiscrete_normed_field 𝕜] [normed_add_group E] [normed_space 𝕜 E]
  [nontrivial E]
...
(E : Type*) [seminormed_add_group E] [normed_space 𝕜' E]

instance {𝕜 : Type*} {𝕜' : Type*} {E : Type*} [I : seminormed_add_group E] :
  seminormed_add_group (restrict_scalars 𝕜 𝕜' E) := I

instance {𝕜 : Type*} {𝕜' : Type*} {E : Type*} [I : normed_add_group E] :
  normed_add_group (restrict_scalars 𝕜 𝕜' E) := I
...
def module.restrict_scalars.normed_space_orig {𝕜 : Type*} {𝕜' : Type*} {E : Type*}
  [normed_field 𝕜'] [seminormed_add_group E] [I : normed_space 𝕜' E] :
