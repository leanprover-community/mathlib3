...
variables {𝕜 : Type*} [nondiscrete_normed_field 𝕜] {E : Type*} [normed_add_group E] [normed_space 𝕜 E]
  {F : Type*} [normed_add_group F] [normed_space 𝕜 F] {G : Type*} [normed_add_group G] [normed_space 𝕜 G]
