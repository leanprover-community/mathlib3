...
variables [normed_add_group V] [metric_space P] [normed_add_torsor V P]
variables [normed_add_group W] [metric_space Q] [normed_add_torsor W Q]
variables [normed_add_group W₂] [metric_space Q₂] [normed_add_torsor W₂ Q₂]
...
noncomputable instance : normed_add_group (V →A[𝕜] W) :=
normed_add_group.of_core _
