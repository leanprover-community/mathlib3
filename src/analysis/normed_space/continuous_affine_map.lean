...
variables [normed_group W₂] [metric_space Q₂] [normed_add_torsor W₂ Q₂]
variables [valued_field R] [normed_space R V] [normed_space R W] [normed_space R W₂]
variables [nondiscrete_valued_field 𝕜] [normed_space 𝕜 V] [normed_space 𝕜 W] [normed_space 𝕜 W₂]
