...
variables {F E₁ : Type*} [seminormed_add_group F]
  [normed_add_group E₁] [module R E₁]
...
variables {𝕜 : Type*} {V₁ V₂  : Type*} {P₁ P₂ : Type*}
  [normed_field 𝕜]
  [normed_add_group V₁] [seminormed_add_group V₂]
...
{E : Type v} [normed_add_group E] [normed_space 𝕜 E]
{F : Type w} [normed_add_group F] [normed_space 𝕜 F]
...
@[irreducible] def lipschitz_extension_constant
  (E' : Type*) [normed_add_group E'] [normed_space ℝ E'] [finite_dimensional ℝ E'] : ℝ≥0 :=
...
lemma lipschitz_extension_constant_pos
  (E' : Type*) [normed_add_group E'] [normed_space ℝ E'] [finite_dimensional ℝ E'] :
...
variables (𝕜 : Type u) [nondiscrete_normed_field 𝕜]
(E : Type v) [normed_add_group E] [normed_space 𝕜 E] [proper_space 𝕜]
...
instance finite_dimensional.proper_real
  (E : Type u) [normed_add_group E] [normed_space ℝ E] [finite_dimensional ℝ E] : proper_space E :=
...
lemma exists_mem_frontier_inf_dist_compl_eq_dist {E : Type*} [normed_add_group E]
...
lemma is_compact.exists_mem_frontier_inf_dist_compl_eq_dist {E : Type*} [normed_add_group E]
...
lemma summable_norm_iff {α E : Type*} [normed_add_group E] [normed_space ℝ E] [finite_dimensional ℝ E]
...
lemma summable_of_is_O' {ι E F : Type*} [normed_add_group E] [complete_space E] [normed_add_group F]
...
lemma summable_of_is_O_nat' {E F : Type*} [normed_add_group E] [complete_space E] [normed_add_group F]
