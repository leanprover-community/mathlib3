...
theory for `seminormed_add_group` and we specialize to `normed_add_group` when needed.
-/
open function set
...
variables {R R₂ R₃ R₄ E E₂ E₃ E₄ F : Type*} [semiring R] [semiring R₂] [semiring R₃] [semiring R₄]
  ...
  [ring_hom_comp_triple σ₃₂ σ₂₁ σ₃₁] [ring_hom_comp_triple σ₄₂ σ₂₁ σ₄₁]
  [ring_hom_comp_triple σ₄₃ σ₃₂ σ₄₂] [ring_hom_comp_triple σ₄₃ σ₃₁ σ₄₁]
  [seminormed_add_group E] [seminormed_add_group E₂] [seminormed_add_group E₃] [seminormed_add_group E₄]
  [module R E] [module R₂ E₂] [module R₃ E₃] [module R₄ E₄]
  [normed_add_group F] [module R F]

/-- A `σ₁₂`-semilinear isometric embedding of a normed `R`-module into an `R₂`-module. -/
structure linear_isometry (σ₁₂ : R →+* R₂) (E E₂ : Type*) [seminormed_add_group E]
  [seminormed_add_group E₂] [module R E] [module R₂ E₂] extends E →ₛₗ[σ₁₂] E₂ :=
...
def simps.apply (σ₁₂ : R →+* R₂) (E E₂ : Type*) [seminormed_add_group E]
  [seminormed_add_group E₂] [module R E] [module R₂ E₂] (h : E →ₛₗᵢ[σ₁₂] E₂) : E → E₂ := h
...
structure linear_isometry_equiv (σ₁₂ : R →+* R₂) {σ₂₁ : R₂ →+* R} [ring_hom_inv_pair σ₁₂ σ₂₁]
  [ring_hom_inv_pair σ₂₁ σ₁₂] (E E₂ : Type*) [seminormed_add_group E] [seminormed_add_group E₂]
