...
variables {𝕜 : Type u} {ι : Type v} {ι' : Type v'} {n : ℕ}
  ...
  {G : Type wG} {G' : Type wG'}
  [decidable_eq ι] [fintype ι] [decidable_eq ι'] [fintype ι'] [nondiscrete_valued_field 𝕜]
...
section
variables {𝕜' : Type*} [valued_field 𝕜'] [normed_space 𝕜' G] [smul_comm_class 𝕜 𝕜' G]
