...
add_comm_group.to_add_comm_monoid normed_add_group.to_add_comm_group normed_space.to_module'
...
variables {𝕜 : Type u} {ι : Type v} {ι' : Type v'} {n : ℕ}
  ...
  [Π i, normed_add_group (E i)] [Π i, normed_space 𝕜 (E i)]
  [Π i, normed_add_group (E₁ i)] [Π i, normed_space 𝕜 (E₁ i)]
  [Π i, normed_add_group (E' i)] [Π i, normed_space 𝕜 (E' i)]
  [Π i, normed_add_group (Ei i)] [Π i, normed_space 𝕜 (Ei i)]
  [normed_add_group G] [normed_space 𝕜 G] [normed_add_group G'] [normed_space 𝕜 G']
...
begin
  ...
  obtain ⟨ε : ℝ, ε0 : 0 < ε, hε : ∀ m : Π i, E i, ∥m - 0∥ < ε → ∥f m - f 0∥ < 1⟩ :=
    normed_add_group.tendsto_nhds_nhds.1 (hf.tendsto 0) 1 zero_lt_one,
...
/-- Continuous multilinear maps themselves form a normed space with respect to
    the operator norm. -/
instance normed_add_group : normed_add_group (continuous_multilinear_map 𝕜 E G) :=
normed_add_group.of_core _ ⟨op_norm_zero_iff, op_norm_add_le, op_norm_neg⟩

/-- An alias of `continuous_multilinear_map.normed_add_group` with non-dependent types to help typeclass
search. -/
instance normed_add_group' : normed_add_group (continuous_multilinear_map 𝕜 (λ i : ι, G) G') :=
continuous_multilinear_map.normed_add_group
...
theorem le_op_norm_mul_pow_of_le {Ei : fin n → Type*} [Π i, normed_add_group (Ei i)]
...
lemma norm_pi {ι' : Type v'} [fintype ι'] {E' : ι' → Type wE'} [Π i', normed_add_group (E' i')]
...
def piₗᵢ {ι' : Type v'} [fintype ι'] {E' : ι' → Type wE'} [Π i', normed_add_group (E' i')]
