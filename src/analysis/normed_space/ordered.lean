...
/-- A `normed_linear_ordered_group` is an additive group that is both a `normed_add_group` and
...
@[priority 100] instance normed_linear_ordered_group.to_normed_add_group (α : Type*)
  [normed_linear_ordered_group α] : normed_add_group α :=
