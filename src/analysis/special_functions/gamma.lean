...
begin
  ...
  rw ←has_finite_integral_norm_iff, simp_rw norm_eq_abs, simp_rw complex.abs_mul,
  apply has_finite_integral.const_mul,
  apply ((real.Gamma_integral_convergent hs).mono_set Ioc_subset_Ioi_self).has_finite_integral.congr,
  rw eventually_eq, rw ae_restrict_iff',
