...
begin
  ...
  { rcases eq_or_ne x 0 with rfl|hx0,
    { rcases eq_or_ne y ⊤ with rfl|hy; cases hz with hz hz; simp [*, hz.not_lt] },
    rcases eq_or_ne y 0 with rfl|hy0, { exact (hx0 (bot_unique hxy)).elim },
    rcases eq_or_ne x ⊤ with rfl|hx, { cases hz with hz hz; simp [hz, top_unique hxy] },
    rcases eq_or_ne y ⊤ with rfl|hy, { cases hz with hz hz; simp * },
    simp only [*, false_and, and_false, false_or, if_false],
    lift x to ℝ≥0 using hx, lift y to ℝ≥0 using hy,
    norm_cast at *,
