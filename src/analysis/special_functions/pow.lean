...
by rw [rpow_def, complex.of_real_add, complex.cpow_add _ _ (complex.of_real_ne_zero.mpr hx),
  complex.of_real_int_cast, complex.cpow_int_cast, ← complex.of_real_fzpow, mul_comm,
...
by simp only [rpow_def, ← complex.of_real_fzpow, complex.cpow_int_cast,
...
begin
  ...
  simp only [rpow_int_cast, zpow_one, fzpow_neg],
end
