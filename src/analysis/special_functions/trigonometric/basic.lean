...
lemma tendsto_sin_pi_div_two : tendsto sin (𝓝ₗ' (π/2)) (𝓝 1) :=
by { convert continuous_sin.continuous_within_at, simp }

lemma tendsto_cos_pi_div_two : tendsto cos (𝓝ₗ' (π/2)) (𝓝ᵣ' 0) :=
begin
...
lemma tendsto_tan_pi_div_two : tendsto tan (𝓝ₗ' (π/2)) at_top :=
begin
...
lemma tendsto_sin_neg_pi_div_two : tendsto sin (𝓝ᵣ' (-(π/2))) (𝓝 (-1)) :=
by { convert continuous_sin.continuous_within_at, simp }

lemma tendsto_cos_neg_pi_div_two : tendsto cos (𝓝ᵣ' (-(π/2))) (𝓝ᵣ' 0) :=
begin
  apply tendsto_nhds_within_of_tendsto_nhds_of_eventually_within,
  { convert continuous_cos.continuous_within_at, simp },
...
lemma tendsto_tan_neg_pi_div_two : tendsto tan (𝓝ᵣ' (-(π/2))) at_bot :=
begin
