...
@[simp]
lemma left_triangle'' {f : a ⟶ b} {g : b ⟶ a} (adj : f ⊣ g) :
    adj.unit ▷ f ⊗≫ f ◁ adj.counit = (λ_ f).hom ≫ (ρ_ f).inv :=
begin
...
@[simp]
lemma right_triangle'' {f : a ⟶ b} {g : b ⟶ a} (adj : f ⊣ g) :
    g ◁ adj.unit ⊗≫ adj.counit ▷ g = (ρ_ g).hom ≫ (λ_ g).inv :=
begin
  dsimp [bicategorical_comp],
  simp
end
...
begin
  calc _ =
  𝟙 _ ⊗≫ g₁ ◁ adj₂.unit ▷ 𝟙 a ⊗≫ (adj₁.counit ▷ (g₂ ≫ 𝟙 a) ≫
    𝟙 b ◁ g₂ ◁ adj₁.unit) ⊗≫ 𝟙 b ◁ adj₂.counit ▷ g₁ ⊗≫ 𝟙 _ : _
  ... =
  𝟙 _ ⊗≫ g₁ ◁ (adj₂.unit ▷ 𝟙 a ≫ (f ≫ g₂) ◁ adj₁.unit) ⊗≫
    (adj₁.counit ▷ (g₂ ≫ f) ≫ 𝟙 b ◁ adj₂.counit) ▷ g₁ ⊗≫ 𝟙 _ : _
  ... =
  𝟙 _ ⊗≫ g₁ ◁ 𝟙 a ◁ adj₁.unit ⊗≫ g₁ ◁ (adj₂.unit ▷ f ⊗≫
    f ◁ adj₂.counit) ▷ g₁ ⊗≫ adj₁.counit ▷ 𝟙 b ▷ g₁ ⊗≫ 𝟙 _ : _
  ... =
  𝟙 _ ⊗≫ (g₁ ◁ adj₁.unit ⊗≫ adj₁.counit ▷ g₁) ⊗≫ 𝟙 _ : _
  ... = _ : _,
  { assoc_simps, coherence },
  {  {rw ←whisker_exchange, assoc_simps, coherence } },
  {  { simp_rw ←whisker_exchange, simp only [bicategorical_comp], assoc_simps, coherence } },
  { rw left_triangle'', simp only [bicategorical_comp], assoc_simps, coherence },
