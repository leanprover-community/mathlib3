...
begin
  ...
  -- --right_unitor_comp
  -- case right_unitor     { dsimp, dsimp [id_def, comp_def], simp [bicategory.whisker_right_id] },
  -- case right_unitor_inv { dsimp, dsimp [id_def, comp_def], simp [bicategory.whisker_right_id] }
end
