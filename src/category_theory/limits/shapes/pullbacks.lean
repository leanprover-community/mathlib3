...
abbreviation pullback.map_desc {X Y S T : C} (f : X ⟶ S) (g : Y ⟶ S) (i : S ⟶ T) [has_pullback f g]
...
pullbacks. This is right adjoint to `over.map` (See `category_theory/adjunction/over`.) -/
