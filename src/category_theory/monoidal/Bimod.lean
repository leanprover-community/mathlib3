...
begin
  ...
  { dsimp,
    ...
    coherence, },
  { dsimp,
    simp only [id_tensor_comp, category.assoc, tensor_id, iso.inv_hom_id_assoc,
      tensor_id_comp_id_tensor],
    slice_lhs 2 3 { rw associator_inv_naturality },
    simp only [tensor_id, category.assoc, id_tensor_comp_tensor_id], },
end
...
begin
  ...
  { dsimp,
    ...
    slice_rhs 3 4 { rw associator_inv_naturality },
    simp only [tensor_id, category.assoc, tensor_id_comp_id_tensor, id_tensor_comp_tensor_id,
      iso.hom_inv_id_assoc], },
  { dsimp,
    simp only [comp_tensor_id, category.assoc, iso.inv_hom_id_assoc],
...
begin
  ...
  erw ι_comp_coequalizer_comparison_assoc,
  dsimp, simp only [tensor_id, id_tensor_comp_tensor_id_assoc], dsimp,
  ...
  simp only [category.id_comp, ι_colim_map, parallel_pair_hom_app_one],
...
begin
  ...
  erw ι_comp_coequalizer_comparison_assoc,
  erw ι_comp_coequalizer_comparison_assoc,
  dsimp, simp only [tensor_id_comp_id_tensor_assoc],
...
begin
  ...
  erw ι_comp_coequalizer_comparison_assoc,
  erw ι_comp_coequalizer_comparison_assoc,
  dsimp, simp only [tensor_id, id_tensor_comp_tensor_id_assoc, id_tensor_comp],
  slice_lhs 1 1 { rw ←tensor_id_comp_id_tensor },
  slice_lhs 2 2 { rw [←tensor_left_map, ←ι_comp_coequalizer_comparison] },
  slice_lhs 3 3 { rw ←preserves_coequalizer.iso_hom },
  slice_lhs 3 4 { rw iso.hom_inv_id },
  ...
  slice_rhs 2 3 { rw [←tensor_comp,
                      ι_colim_map, parallel_pair_hom_app_one,
                      ←category.comp_id (𝟙 R.X ≫ 𝟙 R.X), tensor_comp, tensor_comp] },
...
begin
  ...
  erw ι_comp_coequalizer_comparison_assoc,
  erw ι_comp_coequalizer_comparison_assoc,
  dsimp, simp only [tensor_id_comp_id_tensor_assoc, comp_tensor_id],
  slice_lhs 1 1 { rw ←id_tensor_comp_tensor_id },
  slice_lhs 2 2 { rw [←tensor_right_map, ←ι_comp_coequalizer_comparison] },
  slice_lhs 3 3 { rw ←preserves_coequalizer.iso_hom },
  slice_lhs 3 4 { rw iso.hom_inv_id },
...
begin
  ...
  erw ι_comp_coequalizer_comparison_assoc,
  erw ι_comp_coequalizer_comparison_assoc,
  dsimp, simp only [tensor_id, comp_tensor_id, category.assoc, id_tensor_comp],
  slice_lhs 1 1 { rw [←(tensor_left_map _ _ _ (coequalizer.π _ _)),
                      ←ι_comp_coequalizer_comparison,
  ...
  simp only [tensor_id, category.assoc, category.id_comp],
  slice_rhs 2 3 { rw [←tensor_comp,
                      ι_colim_map, parallel_pair_hom_app_one,
                      tensor_comp, id_tensor_comp] },
  ...
  simp only [category.id_comp, ι_colim_map, parallel_pair_hom_app_one],
  slice_lhs 2 3 { rw associator_naturality },
  simp only [tensor_id, category.assoc, tensor_id_comp_id_tensor],
  slice_rhs 3 4 { rw associator_inv_naturality },
  simp only [tensor_id, category.assoc, id_tensor_comp_tensor_id],
  coherence,
end
...
{ hom := begin
  ...
  left_act_hom' := begin
    ...
    ext,
    simp only [category.assoc, tensor_id, id.def, ι_colim_map_assoc, parallel_pair_hom_app_one,
      ι_colim_map, preserves_coequalizer.iso_hom, ι_comp_coequalizer_comparison_assoc,
      tensor_left_map],
    slice_rhs 1 2 { rw ←tensor_comp },
    simp only [category.comp_id, category.assoc, ι_colim_map, parallel_pair_hom_app_one,
      id_tensor_comp],
    slice_rhs 2 2 { rw [←(tensor_left_map _ _ _ (coequalizer.π _ _)),
                        ←ι_comp_coequalizer_comparison] },
    slice_rhs 3 3 { rw ←preserves_coequalizer.iso_hom },
    slice_rhs 3 4 { rw iso.hom_inv_id },
    simp only [category.id_comp, ι_colim_map, parallel_pair_hom_app_one, category.assoc],
  ...
  right_act_hom' := begin
    ...
    slice_lhs 1 3 { rw iso.hom_inv_id_assoc },
    ext,
    simp only [category.assoc, id.def, ι_colim_map_assoc, parallel_pair_hom_app_one, ι_colim_map,
      preserves_coequalizer.iso_hom, ι_comp_coequalizer_comparison_assoc, tensor_right_map],
    slice_rhs 1 2 { rw ←tensor_comp },
    simp only [category.comp_id, category.assoc, ι_colim_map, parallel_pair_hom_app_one,
      comp_tensor_id],
    slice_rhs 2 2 { rw [←(tensor_right_map _ _ _ (coequalizer.π _ _)),
                        ←ι_comp_coequalizer_comparison] },
    slice_rhs 3 3 { rw ←preserves_coequalizer.iso_hom },
    slice_rhs 3 5 { rw iso.hom_inv_id_assoc },
    simp only [ι_colim_map, parallel_pair_hom_app_one],
    slice_rhs 1 2 { rw associator_naturality },
