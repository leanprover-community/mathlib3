...
meta def tensor_simps : tactic unit :=
`[simp only [
    ...
    monoidal_category.tensor_hom_assoc,
    monoidal_category.id_tensor_tensor,
    monoidal_category.id_unit_tensor,
    monoidal_category.tensor_id_unit]]
...
/-- The main part of `coherence` tactics. -/
