...
{ F := s,
  ...
  associativity := begin
    ...
    dsimp, simp only [category.id_comp, category_theory.functor.map_id, is_iso.inv_hom_id_assoc],
    congr' 1,
  ...
  left_unitality := begin
    ...
    dsimp,
    simp only [category.id_comp, is_iso.inv_hom_id_assoc, category_theory.functor.map_id],
  ...
  right_unitality := begin
    ...
    simp only [category.comp_id, category.id_comp, category.assoc,
      ...
      category_theory.functor.map_comp, functor.image_preimage,
      obj_zero_map_μ_app, is_iso.hom_inv_id_assoc],
