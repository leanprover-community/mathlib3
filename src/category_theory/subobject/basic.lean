...
eq_of_comm (i.trans (underlying_iso f).symm) $ by simv [w]
...
eq_mk_of_comm _ ((underlying_iso f).trans i) $ by simv [w]
...
-- whose left hand side is not in simv normal form.
