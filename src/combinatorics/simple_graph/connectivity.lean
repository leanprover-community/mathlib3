...
begin
  induction p,
  { exact false.elim he, },
  { simp only [cons_support, multiset.mem_cons],
    simp only [cons_edges, multiset.mem_cons, quotient.eq] at he,
    cases he,
    { cases he,
      { exact or.inl rfl, },
      { cases p_p; simp, }, },
...
begin
  rw [is_trail, concat_edges, multiset.nodup_add] at h,
  exact h.1,
end
