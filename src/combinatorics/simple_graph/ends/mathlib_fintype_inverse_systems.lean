...
@[instance] def Joppreo : preorder Jᵒᵖ := {
...
@[instance] def Jopdir  : is_directed Jᵒᵖ (≤) :=
...
begin
  ...
  have F'sections_nempty : F'.sections.nonempty :=
    @nonempty_sections_of_fintype_inverse_system.{u v} Jᵒᵖ Joppreo Jopdir F' fin' nempty',
