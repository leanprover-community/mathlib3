...
-- (1 - k ^ (-1 / 8)) * b ≤ 2 * k ^ (1 / 4) * log k + 2 * k ^ (7 / 8) + (1 + k ^ (-1 / 4)) ^ 2 * t

-- (1 - k ^ (-1 / 8)) * b ≤ 4 * k ^ (7 / 8) + (1 + k ^ (-1 / 4)) ^ 2 * t
-- b ≤ (1 - k ^ (-1 / 8))⁻¹ * (4 * k ^ (7 / 8) + (1 + k ^ (-1 / 4)) ^ 2 * t)
-- b ≤ (1 + k ^ (1 / 16)) * (4 * k ^ (7 / 8) + (1 + k ^ (-1 / 4)) ^ 2 * t)

-- b ≤ (2 k ^ (1 / 16)) * (4 * k ^ (7 / 8)) + (2 k ^ (1 / 16)) * ((1 + k ^ (-1 / 4)) ^ 2 * t)
