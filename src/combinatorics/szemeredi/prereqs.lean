...
begin
  ...
  { rw [finset.card_empty, nat.cast_zero] at hA',
    simpa [(nonpos_of_mul_nonpos_right hA' hδ₁).antisymm (nat.cast_nonneg _)] using hδ' },
  obtain rfl | hB'' := B'.eq_empty_or_nonempty,
  { rw [finset.card_empty, nat.cast_zero] at hB',
    simpa [(nonpos_of_mul_nonpos_right hB' hδ₁).antisymm (nat.cast_nonneg _)] using hδ' },
