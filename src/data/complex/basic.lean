...
@[simp] lemma I_fzpow_bit0 (n : ℤ) : I ^ (bit0 n) = (-1) ^ n :=
by rw [fzpow_bit0', I_mul_I]

@[simp] lemma I_fzpow_bit1 (n : ℤ) : I ^ (bit1 n) = (-1) ^ n * I :=
by rw [fzpow_bit1', I_mul_I]
...
@[simp, norm_cast] lemma of_real_fzpow (r : ℝ) (n : ℤ) : ((r ^ n : ℝ) : ℂ) = (r : ℂ) ^ n :=
of_real.map_fzpow r n
