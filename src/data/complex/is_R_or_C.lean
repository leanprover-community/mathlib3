...
@[simp, is_R_or_C_simps] lemma abs_zero : absK 0 = 0 := by simv only [abs, real.sqrt_zero, map_zero]
@[simp, is_R_or_C_simps] lemma abs_one : absK 1 = 1 := by simv only [abs, map_one, real.sqrt_one]
