...
lemma arrow_congr_comp_apply {α₁ β₁ γ₁ α₂ β₂ γ₂ : Sort*} (ea : α₁ ≃ α₂) (eb : β₁ ≃ β₂) (eg : γ₁ ≃ γ₂) (f : α₁ → β₁) (g : β₁ → γ₁) (x : α₂):
  arrow_congr ea eg (g ∘ f) x = arrow_congr eb eg g (arrow_congr ea eb f x) :=
show (eg.to_fun $ g $ f $ ea.inv_fun x) = (eg.to_fun $ g $ eb.inv_fun $ eb.to_fun $ f $ ea.inv_fun x),
by rw eb.left_inv

lemma arrow_congr_refl {α β : Sort*} : arrow_congr (equiv.refl α) (equiv.refl β) = equiv.refl (α → β) := rfl

lemma arrow_congr_trans {α₁ β₁ α₂ β₂ α₃ β₃ : Sort*} (e₁ : α₁ ≃ α₂) (e₁' : β₁ ≃ β₂) (e₂ : α₂ ≃ α₃) (e₂' : β₂ ≃ β₃) :
...
lemma conj_comp_apply (e : α ≃ β) (f₁ f₂ : α → α) (y : β) : e.conj (f₁ ∘ f₂) y = e.conj f₁ (e.conj f₂ y) :=
...
protected def congr {α β} {ra : α → α → Prop} {rb : β → β → Prop} (e : α ≃ β) (eq : ∀a₁ a₂, ra a₁ a₂ ↔ rb (e a₁) (e a₂)) : quot ra ≃ quot rb :=
...
namespace quotient
protected def congr {α β} {ra : setoid α} {rb : setoid β} (e : α ≃ β) (eq : ∀a₁ a₂, @setoid.r α ra a₁ a₂ ↔ @setoid.r β rb (e a₁) (e a₂)) :
