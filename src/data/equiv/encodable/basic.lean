...
/-- A version of `classical.axiom_of_choice` for `encodable` types. This version does not depend on
`classical.choice`. -/
...
/-- A version of `classical.skolem` for `encodable` types. This version does not depend on
`classical.choice`. -/
