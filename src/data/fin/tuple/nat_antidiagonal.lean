...
| (k + 1) n := begin
  ...
  simv only [mem_antidiagonal, prod.forall, and_imp, forall_apply_eq_imp_iff₂],
  simv only [fin.pi_lex_lt_cons_cons, eq_self_iff_true, true_and, lt_self_iff_false, false_or],
