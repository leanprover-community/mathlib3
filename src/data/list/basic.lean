...
begin
  ...
  by_cases p₁ : h₁ = h₂,
  { simp only [p₁, list.erase_cons_head, if_true, list.mem_cons_iff, true_or, eq_self_iff_true],
    repeat { rw count_cons' },
    by_cases p₂ : h₂ = a,
    { simp only [*, if_true, add_comm, eq_self_iff_true],
      rw min_add_add_left, },
    { rw [if_neg (ne.symm p₂), count_bag_inter],
      simp only [add_zero], } },
  { simp only [*, list.mem_cons_iff, false_or],
    ...
    { rw [list.erase_cons, if_neg (ne.symm p₁), count_cons', count_cons', count_cons',
      ...
      { simp only [add_zero, add_comm], rw count_erase_of_ne p₃,
        simp only [eq_self_iff_true, zero_add], },
      { rw [←p₃, count_erase_self],
        ...
        subst p₃,
        exact count_pos.2 h },
      { simp only [add_zero], rw count_erase_of_ne p₃, } },
    { rw count_bag_inter,
      by_cases p₂ : a = h₁,
