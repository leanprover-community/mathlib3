...
@[simp] theorem powerset_zero : @powerset α 0 = 0::ₘ0 := rfl

@[simp] theorem powerset_cons (a : α) (s) :
  powerset (a::ₘs) = powerset s + map (cons a) (powerset s) :=
