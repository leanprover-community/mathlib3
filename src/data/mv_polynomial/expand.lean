...
by simv only [expand, bind₁_X_left, alg_hom.id_apply, ring_hom.to_fun_eq_coe,
...
by { apply alg_hom_ext, intro i, simv only [alg_hom.comp_apply, bind₁_X_right], }
...
by { ext1 φ, simv only [rename_expand, alg_hom.comp_apply] }
