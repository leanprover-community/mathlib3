...
begin
  ...
  { introsI R _ _ p h,
    let e := (ring_equiv_congr_left R fin_zero_equiv').trans (mv_polynomial.pempty_ring_equiv R),
    apply e.injective,
    ...
    { rw [← this],
      simp only [coe_eval₂_hom, ring_equiv_congr_left_apply, pempty_ring_equiv_apply,
