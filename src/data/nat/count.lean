...
begin
  rw [count_eq_card_filter_range, count_eq_card_filter_range, count_eq_card_filter_range,
    range_add, filter_union, card_disjoint_union, map_filter, add_left_embedding, card_map,
