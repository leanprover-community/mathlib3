...
begin
  ...
  exact lt_mul_of_one_lt_right ((pred n).succ_pos) ((lt_of_lt_of_le one_lt_two
...
begin
  ...
  exact add_lt_add_of_lt_of_le (lt_of_le_of_lt this ((lt_mul_iff_one_lt_right (zero_lt_two.trans_le
