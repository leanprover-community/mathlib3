...
begin
  split,
  { cases lt_or_ge 1 b with one_lt_b b_le_one,
    { cases le_or_gt b n with b_le_n n_lt_b,
    { rw [log_of_one_lt_of_le one_lt_b b_le_n, succ_inj',
      ...
      { exfalso, exact lt_irrefl _ (lt_of_lt_of_le one_lt_b b_small) }, },
    { rw log_eq_zero (or.inl n_lt_b),
      intro bad, exfalso, exact zero_ne_one bad, }, },
    { rw log_eq_zero (or.inr b_le_one),
      intro bad, exfalso, exact zero_ne_one bad, }, },
