...
@[simp] lemma eval_smul [monoid S] [distrib_mul_action S R] [smul_assoc_class S R R]
  (s : S) (p : R[X]) (x : R) :
...
@[simp] lemma smul_comp [monoid S] [distrib_mul_action S R] [smul_assoc_class S R R]
