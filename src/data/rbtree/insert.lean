...
begin
  ...
  { specialize ih h_rb_l,
    obtain rfl := of_get_color_eq_red hr h_rb_l,
    simp [ins_rb_result] at ih,
    apply balance1_node_rb; assumption },
  { specialize ih h_rb_l,
    obtain rfl := of_get_color_ne_red hnr h_rb_l,
    simp [ins_rb_result] at ih, cases ih,
    constructor, constructor; assumption },
  { constructor, constructor; assumption },
  { specialize ih h_rb_r,
    obtain rfl := of_get_color_eq_red hr h_rb_r,
    simp [ins_rb_result] at ih,
    apply balance2_node_rb; assumption },
  { specialize ih h_rb_r,
    obtain rfl := of_get_color_ne_red hnr h_rb_r,
    simp [ins_rb_result] at ih, cases ih,
    constructor, constructor; assumption }
end
