...
attribute [instance, priority 100] is_galois.to_is_separable is_galois.to_normal
...
lemma separable [h : is_galois F E] (x : E) : (minpoly F x).separable := is_separable.separable F x
