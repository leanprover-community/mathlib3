...
begin
  ...
  { apply eval_gcd_eq_zero,
    { rw [eval_comp,eval_sub,eval_mul,eval_C, eval_C, eval_X,add_sub_cancel,
  ...
  { intros x hx,
    ...
    specialize hc ((ιEE' γ) - (ιFE' c) * x) (begin
      ...
      rw [eval₂_comp, eval₂_sub, eval₂_mul,eval₂_C, eval₂_C,eval₂_X] at f_root,
      exact f_root,
    end),
  ...
  { rw [map_comp, map_map,composition, map_sub, map_mul, map_C,map_C,map_X],
    refl },
