...
def separable_degree (f : polynomial F) [has_separable_contraction q f] : 
ℕ := polynomial.nat_degree (separable_contraction q f)

/- Every irreducible polynomial can be contracted to a separable polynomial. 
https://stacks.math.columbia.edu/tag/09H0 -/
instance irreducible_has_separable_contraction 
{F : Type} [field F] (q : ℕ) [hF : exp_char F q]
...
[hf : has_separable_contraction 1 f] :
(separable_degree 1 f) = f.nat_degree :=
begin
