...
lemma mul_norm_eq_sub_norm_pow_two {x y z : V}
...
`AP * BP = abs (BQ ^ 2 - PQ ^ 2)`. -/
lemma mul_dist_eq_sub_dist_pow_two {a b p q : P}
...
begin
  ...
  { rw ← hd at hc,
    rw ← hb at ha hd,
    rw [mul_dist_eq_sub_dist_pow_two hapb ha, mul_dist_eq_sub_dist_pow_two hcpd hc, hd] },
  all_goals { simp },
end
