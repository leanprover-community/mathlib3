...
begin
  ...
  { rw [set.image_image],
    ext x,
    simp_rw [set.mem_Union, set.mem_image, set.mem_singleton_iff, set.mem_sdiff_singleton],
    split,
    { rintros ⟨i, rfl⟩,
...
begin
  ...
  { rintro ⟨hne, h⟩,
    ...
    rw [vector_span_eq_span_vsub_set_left_ne ℝ (set.mem_insert _ _),
        ...
        set.sdiff_singleton_eq_self (λ h, hne (set.mem_singleton_iff.1 h)), set.image_singleton],
...
begin
  ...
  { right,
    ...
    rw set.insert_sdiff_self_of_not_mem ho at hs,
