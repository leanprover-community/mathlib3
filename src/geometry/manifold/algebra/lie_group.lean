...
class lie_add_group {𝕜 : Type*} [nondiscrete_valued_field 𝕜]
...
class lie_group {𝕜 : Type*} [nondiscrete_valued_field 𝕜]
  {H : Type*} [topological_space H]
  {E : Type*} [normed_group E] [normed_space 𝕜 E] (I : model_with_corners 𝕜 E H)
...
@[to_additive]
instance {𝕜 : Type*} [nondiscrete_valued_field 𝕜] {H : Type*} [topological_space H]
  {E : Type*} [normed_group E] [normed_space 𝕜 E]  {I : model_with_corners 𝕜 E H}
  {G : Type*} [topological_space G] [charted_space H G] [group G] [lie_group I G]
  {E' : Type*} [normed_group E'] [normed_space 𝕜 E']
  {H' : Type*} [topological_space H'] {I' : model_with_corners 𝕜 E' H'}
...
instance normed_space_lie_add_group {𝕜 : Type*} [nondiscrete_valued_field 𝕜]
  {E : Type*} [normed_group E] [normed_space 𝕜 E] :
