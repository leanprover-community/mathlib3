...
variables {ι : Type uι}
{E : Type uE} [normed_add_group E] [normed_space ℝ E] [finite_dimensional ℝ E]
{F : Type uF} [normed_add_group F] [normed_space ℝ F]
...
lemma smooth_to_partition_of_unity {E : Type uE} [normed_add_group E] [normed_space ℝ E]
  {H : Type uH} [topological_space H] {I : model_with_corners ℝ E H}
