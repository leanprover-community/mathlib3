...
structure model_with_corners (𝕜 : Type*) [nondiscrete_normed_field 𝕜]
  (E : Type*) [normed_add_group E] [normed_space 𝕜 E] (H : Type*) [topological_space H]
...
def model_with_corners_self (𝕜 : Type*) [nondiscrete_normed_field 𝕜]
  (E : Type*) [normed_add_group E] [normed_space 𝕜 E] : model_with_corners 𝕜 E E :=
...
@[simps (lemmas_only)] def model_with_corners.prod
  ...
  {E : Type v} [normed_add_group E] [normed_space 𝕜 E] {H : Type w} [topological_space H]
  (I : model_with_corners 𝕜 E H)
  {E' : Type v'} [normed_add_group E'] [normed_space 𝕜 E'] {H' : Type w'} [topological_space H']
...
def model_with_corners.pi
  ...
  {E : ι → Type w} [Π i, normed_add_group (E i)] [Π i, normed_space 𝕜 (E i)]
...
variables {𝕜 : Type*} [nondiscrete_normed_field 𝕜]
{E : Type*} [normed_add_group E] [normed_space 𝕜 E] {E' : Type*} [normed_add_group E'] [normed_space 𝕜 E']
{F : Type*} [normed_add_group F] [normed_space 𝕜 F] {F' : Type*} [normed_add_group F'] [normed_space 𝕜 F']
...
instance model_with_corners_self_boundaryless (𝕜 : Type*) [nondiscrete_normed_field 𝕜]
  (E : Type*) [normed_add_group E] [normed_space 𝕜 E] : (model_with_corners_self 𝕜 E).boundaryless :=
⟨by simp⟩
...
variables {E' : Type*} [normed_add_group E'] [normed_space 𝕜 E'] {H' : Type*} [topological_space H']
...
lemma ext_chart_model_space_eq_id (𝕜 : Type*) [nondiscrete_normed_field 𝕜]
  {E : Type*} [normed_add_group E] [normed_space 𝕜 E] (x : E) :
