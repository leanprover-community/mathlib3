...
lemma ext_chart_image_mem_nhds_within' {x' : M} (hx' : x' ∈ (ext_chart_at I x).source) :
  range (ext_chart_at I x) ∈ 𝓝[range I] (ext_chart_at I x x') :=
sorry

lemma ext_chart_image_mem_nhds_within :
  range (ext_chart_at I x) ∈ 𝓝[range I] (ext_chart_at I x x) :=
sorry
