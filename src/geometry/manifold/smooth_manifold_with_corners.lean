...
structure model_with_corners (𝕜 : Type*) [nondiscrete_valued_field 𝕜]
...
def model_with_corners_self (𝕜 : Type*) [nondiscrete_valued_field 𝕜]
...
def model_with_corners.prod
  {𝕜 : Type u} [nondiscrete_valued_field 𝕜]
...
def model_with_corners.pi
  {𝕜 : Type u} [nondiscrete_valued_field 𝕜] {ι : Type v} [fintype ι]
...
class model_with_corners.boundaryless {𝕜 : Type*} [nondiscrete_valued_field 𝕜]
  {E : Type*} [normed_group E] [normed_space 𝕜 E] {H : Type*} [topological_space H]
  (I : model_with_corners 𝕜 E H) : Prop :=
(range_eq_univ : range I = univ)

/-- The trivial model with corners has no boundary -/
instance model_with_corners_self_boundaryless (𝕜 : Type*) [nondiscrete_valued_field 𝕜]
  (E : Type*) [normed_group E] [normed_space 𝕜 E] : (model_with_corners_self 𝕜 E).boundaryless :=
⟨by simp⟩

/-- If two model with corners are boundaryless, their product also is -/
instance model_with_corners.range_eq_univ_prod {𝕜 : Type u} [nondiscrete_valued_field 𝕜]
  {E : Type v} [normed_group E] [normed_space 𝕜 E] {H : Type w} [topological_space H]
...
variables {m n : with_top ℕ} {𝕜 : Type*} [nondiscrete_valued_field 𝕜]
...
class smooth_manifold_with_corners {𝕜 : Type*} [nondiscrete_valued_field 𝕜]
  {E : Type*} [normed_group E] [normed_space 𝕜 E]
  {H : Type*} [topological_space H] (I : model_with_corners 𝕜 E H)
  (M : Type*) [topological_space M] [charted_space H M] extends
  has_groupoid M (cont_diff_groupoid ∞ I) : Prop

lemma smooth_manifold_with_corners.mk' {𝕜 : Type*} [nondiscrete_valued_field 𝕜]
  {E : Type*} [normed_group E] [normed_space 𝕜 E]
  {H : Type*} [topological_space H] (I : model_with_corners 𝕜 E H)
...
instance model_space_smooth {𝕜 : Type*} [nondiscrete_valued_field 𝕜]
  {E : Type*} [normed_group E] [normed_space 𝕜 E] {H : Type*} [topological_space H]
  {I : model_with_corners 𝕜 E H} :
...
instance prod {𝕜 : Type*} [nondiscrete_valued_field 𝕜]
  {E : Type*} [normed_group E] [normed_space 𝕜 E]
  {E' : Type*} [normed_group E'] [normed_space 𝕜 E']
  {H : Type*} [topological_space H] {I : model_with_corners 𝕜 E H}
  {H' : Type*} [topological_space H'] {I' : model_with_corners 𝕜 E' H'}
...
identity.-/
lemma ext_chart_model_space_eq_id (𝕜 : Type*) [nondiscrete_valued_field 𝕜]
