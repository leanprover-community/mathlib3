...
is a vector bundle. -/
structure basic_smooth_vector_bundle_core {𝕜 : Type*} [nondiscrete_valued_field 𝕜]
...
identity. -/
def trivial_basic_smooth_vector_bundle_core {𝕜 : Type*} [nondiscrete_valued_field 𝕜]
{E : Type*} [normed_group E] [normed_space 𝕜 E]
{H : Type*} [topological_space H] (I : model_with_corners 𝕜 E H)
(M : Type*) [topological_space M] [charted_space H M] [smooth_manifold_with_corners I M]
