...
lemma times_cont_mdiff_on_proj {s : set (Z.to_topological_vector_bundle_core.total_space)} :
...
lemma times_cont_mdiff_at_proj {p : Z.to_topological_vector_bundle_core.total_space} :
