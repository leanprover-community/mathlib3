...
@[simp, squash_cast, to_additive, nolint simp_nf]
lemma coe_coe (K : subgroup G) : ↥(K : set G) = K := rfl

attribute [squash_cast, nolint simp_nf] add_subgroup.coe_coe
...
| -[1+ n]        := H.inv_mem' $ H.add_mem hx $ add_submonoid.smul_mem H.to_add_submonoid hx n
...
/-- The image under a monoid hom of the subgroup generated by a set equals the subgroup generated
