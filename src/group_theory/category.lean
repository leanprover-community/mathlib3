...
@[to_additive]
instance bundled_category : bundled_category _ := Mon.bundled_category.restrict_str @group.to_monoid
...
@[to_additive] instance : bundled_category _ :=
Group.bundled_category.restrict_str @comm_group.to_group
