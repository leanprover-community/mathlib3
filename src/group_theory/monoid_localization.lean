...
variables {A : Type*} [add_comm_monoid A] (x : A) {B : Type*} [add_comm_monoid B] (F : away_map x B)
  {C : Type*} [add_comm_monoid C] {g : A →+ C}
...
--attribute [to_additive add_submonoid.localization_map.away_map]
--  submonoid.localization_map.away_map
attribute [to_additive add_submonoid.localization_map.away_map.neg_self]
  submonoid.localization_map.away_map.inv_self
...
@[to_additive] def away.inv_self : away x :=
...
@[reducible, to_additive] def away.monoid_of : submonoid.localization_map.away_map x (away x) :=
...
lemma away.neg_self_eq (x : A) :
  away.neg_self x = add_submonoid.localization_map.away_map.neg_self x (away.add_monoid_of x) :=
mk_eq_add_monoid_of_mk'_apply _ _
