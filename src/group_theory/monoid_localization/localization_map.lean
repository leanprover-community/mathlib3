...
/-!
# Characterization of the localizations of commutative monoids
...
In the subsequent file, we define the localization as a quotient type, `localization`, but the
lemmas in this file are given in terms of localizations up to isomorphism, using maps which satisfy
...
## Tags
localization, monoid localization, characteristic predicate, commutative monoid
-/
...
by simp_rw localization_map.eq
