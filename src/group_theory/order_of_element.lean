...
@[to_additive]
--lemma one_mul_eq_id {M : Type*} [mul_one_class M] : (* (1 : M)) = id := funext mul_one
lemma one_mul_eq_id : ((*) (1 : G)) = id := funext $ λ _, (one_mul _).trans (id.def _).symm

@[to_additive]
lemma mul_one_eq_id : (* (1 : G)) = id := funext $ λ _, (mul_one _).trans (id.def _).symm
---/
