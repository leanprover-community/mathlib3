...
-- Move the next 4 lemmas, + 4 autogenerated one, somewhere else?
@[to_additive]
lemma one_mul_eq_id : ((*) (1 : α)) = id := funext one_mul
...
section group
variables [group α] [add_group H] {x} {i : ℤ}
...
lemma pow_gcd_card_eq_one_iff : a ^ n = 1 ↔ a ^ (gcd n (fintype.card α)) = 1 :=
