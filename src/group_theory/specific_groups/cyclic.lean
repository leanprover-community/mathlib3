...
* `is_simple_group_of_prime_card`, `is_simple_is_cyclic`,
...
@[to_additive is_cyclic_add] class is_cyclic (α : Type u) [group α] : Prop :=
...
instance subis_cyclic {α : Type u} [group α] [is_cyclic α] (H : subgroup α) : is_cyclic H :=
