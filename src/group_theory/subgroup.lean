...
@[simp, to_additive "The `add_subgroup` generated by a set includes the elements of the set."]
lemma mem_closure' {x : G} : x ∈ k → x ∈ closure k := λ hx, mem_closure.2 $ λ K hK, hK hx
