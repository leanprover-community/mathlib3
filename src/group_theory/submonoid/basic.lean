...
def closure : lower_adjoint (coe : submonoid M → set M) :=
{ to_fun := λ s, Inf {S | s ⊆ S},
  gc' := λ s S, ⟨set.subset.trans (λ x hx, mem_Inf.2 (λ S' hS', hS' hx)), λ h, Inf_le h⟩ }

/-- The submonoid generated by a set includes the set. -/
@[simp, to_additive "The `add_submonoid` generated by a set includes the set."]
lemma subset_closure : s ⊆ closure s := closure.subset_closure _
...
lemma closure_eq : closure (S : set M) = S := closure.closure_eq _
