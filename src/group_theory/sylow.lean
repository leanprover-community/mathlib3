...
* `sylow.card_eq_multiplicity`: The cardinality of a Sylow `p`-subgroup of a finite group is
  `p^n`, where `n` is the multiplicity of `p` in the cardinality of the group.
