...
prod_mul_distrib.symm.trans (prod_congr rfl (λ q hq, (ϕ.map_mul _ _).symm.trans (congr_arg ϕ
  (by simp_rw [subtype.ext_iff, submonoid_class.coe_mul, set_like.coe_mk, mul_assoc,
               mul_inv_cancel_left]))))
...
prod_bij' (λ q _, g⁻¹ • q) (λ _ _, mem_univ _) (λ _ _, congr_arg ϕ (by simp_rw [set_like.coe_mk,
