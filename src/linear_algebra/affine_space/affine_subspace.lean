...
{ sup := λ s1 s2, affine_span k (s1 ∪ s2),
  ...
  Inf := λ s, mk (⋂ s' ∈ s, (s' : set P))
                 (λ c p1 p2 p3 hp1 hp2 hp3, set.mem_Inter₂.2 $ λ s2 hs2,
                   s2.smul_vsub_vadd_mem c (set.mem_Inter₂.1 hp1 s2 hs2)
                                           (set.mem_Inter₂.1 hp2 s2 hs2)
                                           (set.mem_Inter₂.1 hp3 s2 hs2)),
