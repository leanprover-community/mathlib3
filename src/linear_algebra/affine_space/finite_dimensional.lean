...
finite_dimensional_vector_span_of_finite k ((set.finite_of_subtype _).image _)
...
finite_dimensional_direction_affine_span_of_finite k ((set.finite_of_subtype _).image _)
...
begin
  ...
  exact _root.finite.of_fintype
    (fintype_of_fintype_ne _ (@fintype.of_finite _ hi.finite_of_is_noetherian))
end
...
⟨finite_of_fin_dim_affine_independent k hi⟩
