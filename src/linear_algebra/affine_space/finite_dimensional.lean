...
finite-dimensional. -/
instance finite_dimensional_vector_span_of_finite [finite ι] (p : ι → P) :
...
instance finite_dimensional_vector_span_image_of_finite [finite ι] (p : ι → P)
...
instance finite_dimensional_direction_affine_span_of_finite [finite ι] (p : ι → P) :
