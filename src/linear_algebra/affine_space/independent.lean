...
begin
  ...
  { have p₁ : P := add_torsor.nonempty.some,
    let sv := basis.of_vector_space_index k V,
  ...
  { rw affine_independent_set_iff_linear_independent_vsub k hp₁ at h,
    let sv := h.extend (set.subset_univ _),
