...
by rw [fintype.total, linear_map.range_comp, linear_equiv.to_linear_map_eq_coe, linear_equiv.range,
    submodule.map_top, finsupp.range_total]

lemma fintype.total_apply (f) : fintype.total α M R v f = ∑ i, f i • v i :=
begin
