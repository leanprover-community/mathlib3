...
def submodule.invariant {V K : Type*} [semiring K] [add_comm_monoid V] [module K V]
  (U : submodule K V) (T : V →ₗ[K] V) : Prop := U ≤ U.comap T
lemma submodule.invariant_iff {V K : Type*} [semiring K] [add_comm_monoid V] [module K V]
  (U : submodule K V) (T : V →ₗ[K] V) : submodule.invariant U T ↔ T '' U ⊆ U :=
