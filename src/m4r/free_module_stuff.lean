import linear_algebra.direct_sum.finsupp m4r.koszul_of_free m4r.exterior_power linear_algebra.finsupp_vector_space
universes u w v
...
begin
  ...
  have := finsupp.ext_iff.1 (finsupp.injective_coe_fn hf) (l.nth_le j
