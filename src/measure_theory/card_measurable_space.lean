...
theorem self_subset_generate_measurable_rec (s : set (set α)) (i : ℵ₁) :
...
theorem empty_mem_generate_measurable_rec (s : set (set α)) (i : ℵ₁) :
...
theorem compl_mem_generate_measurable_rec {s : set (set α)} {i j : ℵ₁} (h : j < i) {t : set α}
...
theorem Union_mem_generate_measurable_rec {s : set (set α)} {i : ℵ₁}
...
theorem generate_measurable_rec_subset (s : set (set α)) {i j : ℵ₁} (h : i ≤ j) :
