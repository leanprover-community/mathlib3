...
variables [normed_add_group α] [opens_measurable_space α] [measurable_space β]
...
variables {E : Type*} [normed_add_group E] [normed_space 𝕜 E] [measurable_space E]
variables [opens_measurable_space E]
variables {F : Type*} [normed_add_group F] [normed_space 𝕜 F] [measurable_space F] [borel_space F]
...
variables {𝕜 : Type*} [nondiscrete_normed_field 𝕜]
variables {E : Type*} [normed_add_group E] [normed_space 𝕜 E] [measurable_space E] [borel_space E]
