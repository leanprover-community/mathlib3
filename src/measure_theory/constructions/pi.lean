...
begin
  ...
  { rw [measure.pi, to_measure_apply _ _ (measurable_set.pi_countable (λ i _, hs i))],
    apply outer_measure.pi_pi_le },
  { haveI : encodable ι := fintype.to_encodable ι,
    rw [← pi'_pi μ s],
    simp_rw [← pi'_pi μ s, measure.pi,
      to_measure_apply _ _ (measurable_set.pi_countable (λ i _, hs i)), ← to_outer_measure_apply],
...
begin
  ...
  { ext, simp },
  simp_rw [measure.map_apply (measurable_const_mul x) (measurable_set.univ_pi_countable hs), h,
...
begin
  ...
  { ext, simp },
  simp_rw [measure.inv, measure.map_apply measurable_inv (measurable_set.univ_pi_countable hs), A,
