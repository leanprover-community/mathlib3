...
* `exist_disjoint_covering_families` is the Besicovitch covering theorem: from any family of
  balls one can extract finitely many disjoint subfamilies covering the same set.
