...
begin
  ...
  { assume x hx ε εpos,
    rw hs at hx,
    simp only [frequently_filter_at_iff, exists_prop, gt_iff_lt, mem_set_of] at hx,
...
begin
  ...
  { assume ε εpos,
    ...
    ... ≤ ε⁻¹ * ρ (s ∩ o) : begin
      ...
      assume x hx,
      rw hs at hx,
      simp only [mem_inter_eq, not_lt, not_eventually, mem_set_of] at hx,
      exact hx.1
    end
...
begin
  ...
  { assume c hc d hd hcd,
    ...
    { simp only [and_imp, exists_prop, not_frequently, not_and, not_lt, not_le, not_eventually,
        mem_set_of, mem_compl_eq, not_forall],
      assume x h1x h2x,
...
begin
  ...
  { assume q hq,
    ...
    { apply v.mul_measure_le_of_subset_lt_lim_ratio_meas hρ,
      ...
      simp only [this, ennreal.coe_lt_top, mem_set_of], },
...
begin
  ...
  { assume q hq,
    ...
    simp only [this, mem_set_of, hq, ennreal.coe_pos], },
