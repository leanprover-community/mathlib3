...
begin
  ...
  have B : tendsto (λ (q : ℝ≥0), (q : ℝ≥0∞) * μ s) (𝓝ᵣ' (0 : ℝ≥0)) (𝓝 ((0 : ℝ≥0) * μ s)),
...
begin
  ...
  { have : tendsto (λ (t : ℝ≥0), (t^2 * ρ s : ℝ≥0∞)) (𝓝ᵣ' 1) (𝓝 ((1 : ℝ≥0)^2 * ρ s)),
  ...
  { have : tendsto (λ (t : ℝ≥0), (t : ℝ≥0∞) * μ.with_density (v.lim_ratio_meas hρ) s) (𝓝ᵣ' 1)
