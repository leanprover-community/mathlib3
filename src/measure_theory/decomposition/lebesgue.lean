...
begin
  ...
  { rw [vector_measure.add_apply, signed_measure.to_complex_measure_apply,
        complex.add_re, re_apply_apply, with_densityᵥ_apply (c.integrable_rn_deriv μ) hi,
  ...
  { rw [vector_measure.add_apply, signed_measure.to_complex_measure_apply,
        complex.add_im, im_apply_apply, with_densityᵥ_apply (c.integrable_rn_deriv μ) hi,
        ← set_integral_re_add_im (c.integrable_rn_deriv μ).integrable_on],
