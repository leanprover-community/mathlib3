...
lemma tendsto_in_measure_iff_norm [seminormed_add_group E] {l : filter ι}
  {f : ι → α → E} {g : α → E} :
...
variables [measurable_space E] [normed_add_group E] [borel_space E]
...
variables [normed_add_group E] {p : ℝ≥0∞}
...
lemma tendsto_in_measure_of_tendsto_snorm_top {E} [normed_add_group E] {f : ι → α → E} {g : α → E}
