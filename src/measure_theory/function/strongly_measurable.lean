...
protected lemma norm {m : measurable_space α} {β : Type*} [normed_add_group β] {f : α → β}
  (hf : strongly_measurable f) :
  strongly_measurable (λ x, ∥f x∥) :=
continuous_norm.comp_strongly_measurable hf

protected lemma nnnorm {m : measurable_space α} {β : Type*} [normed_add_group β] {f : α → β}
  (hf : strongly_measurable f) :
  strongly_measurable (λ x, ∥f x∥₊) :=
continuous_nnnorm.comp_strongly_measurable hf

protected lemma ennnorm {m : measurable_space α} {β : Type*} [normed_add_group β] {f : α → β}
  (hf : strongly_measurable f) :
...
protected lemma norm {β : Type*} [normed_add_group β] {f : α → β} (hf : ae_strongly_measurable f μ) :
  ae_strongly_measurable (λ x, ∥f x∥) μ :=
continuous_norm.comp_ae_strongly_measurable hf

protected lemma nnnorm {β : Type*} [normed_add_group β] {f : α → β} (hf : ae_strongly_measurable f μ) :
  ae_strongly_measurable (λ x, ∥f x∥₊) μ :=
continuous_nnnorm.comp_ae_strongly_measurable hf

protected lemma ennnorm {β : Type*} [normed_add_group β] {f : α → β} (hf : ae_strongly_measurable f μ) :
  ae_measurable (λ a, (∥f a∥₊ : ℝ≥0∞)) μ :=
(ennreal.continuous_coe.comp_ae_strongly_measurable hf.nnnorm).ae_measurable

protected lemma edist {β : Type*} [normed_add_group β] {f g : α → β}
  (hf : ae_strongly_measurable f μ) (hg : ae_strongly_measurable g μ) :
...
lemma _root_.ae_strongly_measurable_with_density_iff {E : Type*} [normed_add_group E] [normed_space ℝ E]
...
variables {G : Type*} {p : ℝ≥0∞} {m m0 : measurable_space α} {μ : measure α}
  [normed_add_group G] [measurable_space G] [borel_space G] [second_countable_topology G]
  {f : α → G}
