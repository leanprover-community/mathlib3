...
begin
  ...
  borelize E,
  letI : separable_space (range f ∪ {0} : set E) := hfm.separable_space_range_union_singleton,
...
begin
  ...
  letI : separable_space (range f ∪ {0} : set F) := hf.separable_space_range_union_singleton,
