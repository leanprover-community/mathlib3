...
variables [normed_add_group F] [normed_space ℝ F] {m : measurable_space α} {μ : measure α}
...
variables [normed_add_group E] [normed_add_group F] [normed_space ℝ F] {p : ℝ≥0∞}
  {G F' : Type*} [normed_add_group G] [normed_add_group F'] [normed_space ℝ F']
...
variables [normed_add_group E] [normed_add_group F] {m : measurable_space α} {μ : measure α}
...
variables {E' : Type*} [normed_add_group E'] [normed_space ℝ E'] [normed_space 𝕜 E']
...
variables [normed_add_group E] [normed_space ℝ E] [complete_space E]
...
lemma integral_norm_eq_lintegral_nnnorm {G} [normed_add_group G]
...
lemma of_real_integral_norm_eq_lintegral_nnnorm {G} [normed_add_group G] {f : α → G}
  (hf : integrable f μ) :
...
variables {H β γ : Type*} [normed_add_group H]
