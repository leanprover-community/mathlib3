...
begin
have F_measurable : ∀ n, ae_measurable (F n) volume, by {sorry,},
have key := uniform_tendsto_integral_of_dominated_convergence F_measurable hlim,
rw differentiable_on,
intros x hx,
