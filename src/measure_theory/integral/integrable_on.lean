...
lemma has_finite_integral_restrict_of_bounded [normed_add_group E] {f : α → E} {s : set α}
...
variables [normed_add_group E] {f g : α → E} {s t : set α} {μ ν : measure α}
...
lemma integrable_indicator_const_Lp {E} [normed_add_group E]
...
lemma integrable_on_Lp_of_measure_ne_top {E} [normed_add_group E]
