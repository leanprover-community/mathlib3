...
lemma integrable_of_interval_integral_norm_bounded [no_bot_order α] [nonempty α]
...
lemma integrable_on_Iic_of_interval_integral_norm_bounded [no_bot_order α] (I : ℝ) (b : α)
