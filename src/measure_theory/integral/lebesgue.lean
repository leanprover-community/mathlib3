...
begin
  ...
  { intros f hf, rw [finset.coe_empty, sdiff_eq_empty, range_subset_singleton] at hf,
  ...
  { intros x s hxs ih f hf,
    ...
    { apply ih, simp only [g, simple_func.coe_piecewise, range_piecewise],
      rw [image_compl_preimage, union_sdiff_distrib, sdiff_sdiff_comm, hf, finset.coe_insert,
        insert_sdiff_self_of_not_mem, sdiff_eq_empty.mpr, set.empty_union],
