  ...
  lintegral_supr
    ...
    (monotone_nat_of_le_succ $ assume n a, classical.by_cases
      ...
      begin
        ...
        simp only [not_not, mem_set_of] at this, exact this n
      end))
  ... = ⨆n, (∫⁻ a, f n a ∂μ) :
...
begin
  ...
  { assume hs,
    ...
    simp only [pi.zero_apply, mem_set_of, filter.mem_mk] at A,
    convert A,
    ext x,
    simp only [and_comm, exists_prop, mem_inter_eq, iff_self, mem_set_of, mem_compl_eq,
               not_forall] },
  { assume hs,
    ...
    { assume x hx,
      ...
      { simp only [fx, mem_union_eq, mem_set_of, eq_self_iff_true, or_true] },
      { left,
...
begin
  ...
  congr',
  ext x,
  simp only [exists_prop, mem_inter_eq, iff_self, mem_set_of, not_forall],
end
