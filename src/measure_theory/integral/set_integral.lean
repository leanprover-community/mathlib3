...
variables {μ : measure α} [normed_add_group E] [complete_space E] [normed_space ℝ E]
  {s : ℕ → set α} {f : α → E}
...
variables [normed_add_group E] {𝕜 : Type*} [normed_field 𝕜] [normed_add_group F] [normed_space 𝕜 F]
  {p : ℝ≥0∞} {μ : measure α}
...
variables {ι : Type*} [normed_add_group E]
...
lemma integral_apply {H : Type*} [normed_add_group H] [normed_space 𝕜 H]
