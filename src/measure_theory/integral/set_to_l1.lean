...
variables {α E F F' G 𝕜 : Type*} {p : ℝ≥0∞}
  ...
  [normed_add_group F] [normed_space ℝ F]
  [normed_add_group F'] [normed_space ℝ F']
  [normed_add_group G]
...
def dominated_fin_meas_additive {β} [seminormed_add_group β] {m : measurable_space α}
...
variables {β : Type*} [seminormed_add_group β] {T T' : set α → β} {C C' : ℝ}
...
lemma eq_zero_of_measure_zero {β : Type*} [normed_add_group β] {T : set α → β} {C : ℝ}
...
lemma eq_zero {β : Type*} [normed_add_group β] {T : set α → β} {C : ℝ}
...
lemma set_to_simple_func_smul {E} [normed_add_group E] [normed_field 𝕜]
...
lemma set_to_L1s_smul {E} [normed_add_group E] [normed_space ℝ E]
