...
begin
  ...
  { intros v hv hKv,
    ...
    rw [measure_union hKv (is_compact.measurable_set hK), singleton_mul, measure_smul] at hKvsub,
    exact hKvsub.not_lt hμUK },
  ...
  { apply hKL.trans hLE,
    simpa only [singleton_mul, mem_smul_set_iff_inv_smul_mem] using hxK },
