...
lemma add_haar_eq_zero_of_disjoint_translates_aux
  {E : Type*} [normed_add_group E] [normed_space ℝ E] [measurable_space E] [borel_space E]
...
variables {E : Type*} [normed_add_group E] [measurable_space E] [normed_space ℝ E]
...
lemma add_haar_ball_center
  {E : Type*} [normed_add_group E] [measurable_space E]
