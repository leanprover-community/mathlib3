...
@[simp] lemma with_densityᵥ_smul {𝕜 : Type*} [nondiscrete_valued_field 𝕜] [normed_space 𝕜 E]
...
lemma with_densityᵥ_smul' {𝕜 : Type*} [nondiscrete_valued_field 𝕜] [normed_space 𝕜 E]
  [smul_comm_class ℝ 𝕜 E] (f : α → E) (r : 𝕜) :
