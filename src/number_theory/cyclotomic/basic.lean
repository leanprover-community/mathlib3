...
noncomputable! def alg_equiv (L' : Type*) [field L'] [algebra K L'] [is_cyclotomic_extension {n} K L'] :
  L ≃ₐ[K] L' :=
...
instance algebra'' {R : Type*} [comm_ring R] [algebra R K] : algebra R (cyclotomic_field n K) :=
splitting_field.algebra' (cyclotomic n K)
