...
begin
  ...
  { have H := congr_arg derivative (cyclotomic_prime_mul_X_sub_one K p),
    ...
    rw [monoid_hom.map_mul, hζ.sub_one_norm_prime hirr hodd, monoid_hom.map_mul, monoid_hom.map_pow,
      ...
      algebra.norm_algebra_map, finrank _ hirr, totient_prime hp.out, ← succ_pred_eq_of_pos hpos,
      pow_succ, mul_comm _ (p : K), coe_coe, ← hζ.minpoly_eq_cyclotomic_of_irreducible hirr] at H,
