...
begin
  ...
  rw [discr_power_basis_eq_norm, finrank _ hirr, power_basis_gen _ hζ,
    ← minpoly_eq_cyclotomic_of_irreducible hζ hirr, totient_prime hp.out],
  congr' 1,
  ...
  { have H := congr_arg derivative (cyclotomic_prime_mul_X_sub_one K p),
    ...
    rw [monoid_hom.map_mul, prime_ne_two.sub_one_norm hζ hirr hodd, monoid_hom.map_mul,
      ...
      ← minpoly_eq_cyclotomic_of_irreducible hζ hirr] at H,
