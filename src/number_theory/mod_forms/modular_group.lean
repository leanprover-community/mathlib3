...
begin
have:= MND A.1, have ad:=A.2,simp [valorsl], rw ad at this, have cg : A.1 1 0* A.1 0 1 =  A.1 0 1* A.1 1 0, by {ring,},
...
split,
intro h,
have:= mat_mul_expl _ A M,  rw ← h, simp [valor_mat_m],intro h, ext i j, fin_cases i; fin_cases j, simp [valor_mat_m] at *, rw h.1,
