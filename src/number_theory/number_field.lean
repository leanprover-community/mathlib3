...
begin
  ...
  { intro ha,
    ...
    haveI : smul_assoc_class F Fx K := smul_assoc_class.of_ring_hom (adjoin_root.lift_hom _ _ hK),
    haveI : smul_assoc_class F Fx A := smul_assoc_class.of_ring_hom (adjoin_root.lift_hom _ _ hA),
