...
begin
  rw [norm_eq_pow_val hf, norm_eq_pow_val hg, ← neg_inj, fzpow_inj],
...
begin
  ...
  simp [p₀, p₁, norm, padic_norm, padic_val_rat, fzpow_neg, padic.cast_eq_of_rat_of_nat],
end
...
by rw [normed_field.norm_fzpow, norm_p]; field_simp
...
begin
  ...
  rw ← neg_inj,
  apply (fzpow_strict_mono h).injective,
  dsimp only,
  rw ← norm_eq_pow_val,
  { simp },
...
begin
  ...
  { apply nat.fzpow_pos_of_pos, exact hp_prime.1.pos },
