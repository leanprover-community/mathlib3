...
begin
  ...
  have hmc : p = 2 ∨ p ∣ int.nat_abs m, { exact prime_two_or_dvd_of_dvd_two_mul_mul_self hp.1 h2m },
  have hnc : p = 2 ∨ p ∣ int.nat_abs n, { exact prime_two_or_dvd_of_dvd_two_mul_mul_self hp.1 h2n },
  by_cases hp2 : p = 2,
  { have h3 : (m ^ 2 + n ^ 2) % 2 = 1,
