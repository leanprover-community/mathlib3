...
This defines `FinPartialOrder`, the category of finite distributive lattices.
-/
...
/-- The category of finite partial orders lattices with monotone functions. -/
...
instance : inhabited FinPartialOrder := ⟨⟨⟨bool⟩⟩⟩
