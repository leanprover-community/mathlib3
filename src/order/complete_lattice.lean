...
le_antisymm
  ...
  (le_infi $ assume i, le_inf
    (inf_le_of_le_left $ infi_le _ _)
    (inf_le_of_le_right $ infi_le _ _))
...
le_antisymm
  ...
  | or.inl i := inf_le_of_le_left $ infi_le _ _
  | or.inr j := inf_le_of_le_right $ infi_le _ _
  end)
...
le_antisymm
  ...
  | sum.inl i := inf_le_of_le_left $ infi_le _ _
  | sum.inr j := inf_le_of_le_right $ infi_le _ _
  end)
