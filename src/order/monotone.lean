...
begin
  ...
  { obtain hfbc | hfcb := le_total (f b) (f c),
    { exact ⟨a, b, d, hab, hbc.trans hcd, or.inr ⟨hfba, hfbc.trans_lt hfcd⟩⟩ },
    { exact ⟨a, c, d, hab.trans hbc, hcd, or.inr ⟨hfcb.trans_lt hfba, hfcd⟩⟩ } },
