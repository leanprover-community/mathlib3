...
protected lemma order_dual : left_ord_continuous f → right_ord_continuous (to_dual ∘ f) := id
...
protected lemma order_dual : right_ord_continuous f → left_ord_continuous (to_dual ∘ f) := id
