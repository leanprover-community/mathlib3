...
import representation_theory.cohomology.LESs.short_exact_sequence
import representation_theory.cohomology.LESs.abelian_category
import representation_theory.cohomology.LESs.fin_functor
import representation_theory.cohomology.LESs.exact_seq
...
begin
  ...
  dsimp only [f],
  sorry,
  --dsimp [← abelian.pseudoelement.comp_apply, to_top_right_kernel],
