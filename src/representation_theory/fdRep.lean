...
by { change add_comm_group ((forget₂ (fdRep k G) (fgModule k)).obj V), apply_instance, }

instance (V : fdRep k G) : module k V :=
by { change module k ((forget₂ (fdRep k G) (fgModule k)).obj V), apply_instance, }

instance (V : fdRep k G) : finite_dimensional k V :=
by { change finite_dimensional k ((forget₂ (fdRep k G) (fgModule k)).obj V), apply_instance, }
