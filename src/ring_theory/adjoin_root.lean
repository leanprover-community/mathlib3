...
/-- The natural isomorphism `(R/I)[x]/(f mod I) ≅ (R[x]/I*R[x])/(f mod I[x])` where
  `f : polynomial R` and `I : ideal R`-/
def polynomial_over_quot_quot_mk_span_equiv_quot_map_C_quot_mk_span :
...
@[simp]
lemma polynomial_over_quot_quot_mk_span_equiv_quot_map_C_quot_mk_span_symm_mk_mk (p : R[X]) :
...
lemma quot_adjoin_root_equiv_quot_polynomial_quot_mk_of (p : R[X]) :
  ...
  (p.map I^.quotient.mk) :=
by rw [quot_adjoin_root_equiv_quot_polynomial_quot, ring_equiv.trans_apply,
    ring_equiv.trans_apply,ring_equiv.trans_apply,quot_map_of_equiv_quot_map_C_map_span_mk_mk,
    quot_map_C_map_span_mk_equiv_quot_map_C_quot_map_span_mk_mk,
    quot_map_C_quot_map_span_mk_equiv_quot_map_C_quot_mk_span_quot_quot_mk,
    polynomial_over_quot_quot_mk_span_equiv_quot_map_C_quot_mk_span_symm_mk_mk]
