...
@[simp] lemma algebraic_independent.algebra_map_aeval_equiv (hv : algebraic_independent R v)
  (p : mv_polynomial ι R) : algebra_map (algebra.adjoin R (range v)) A (hv.aeval_equiv p) =
  aeval v p := rfl
