...
begin
  ...
  { rintros ⟨z, hz, h⟩,
    refine ⟨(is_localization.sec R⁰ z).1, (is_localization.sec R⁰ z).2.1, _, _, _⟩,
    { contrapose! hz,
      rw [← @is_localization.mk'_sec _ _ R⁰ K _ _ _ z, @is_localization.mk'_eq_mul_mk'_one _ _ R⁰ K,
