...
begin--PER GOLFARE, CONSIDERARE TUTTE LE HP SOLO LOCALI E METTERLE TRA PARENTESI
  ...
  have hne_s : s.nonempty,--QUESTE COSE SU Ω E s FORSE SONO LOCALI, CIOÈ SERVONO SOLO A DIM QCS
  ...
  { convert (ideal.is_prime.prod_le (ideal.is_maximal.is_prime hM) hne_s).mp h_φsM,
    ...
    { rintros ⟨P₁, h_P₁Z, h_P₁M⟩,
      ...
      { convert h_P₁M,
        ...
        by_cases m < Ω.length,
        { simp only [*, dif_pos] },
        { exact absurd hm₁ h} } },--VA GOLFATA QUESTA PARENTESI CHE INIZIA A RIGA 660
    { rintros ⟨m, hm₁, hm₂⟩,
