...
lemma equiv [finitely_presented R A] (e : A ≃ₐ[R] B) : finitely_presented R B :=
begin
  obtain ⟨n, f, hf⟩ := spec R A,
...
/-- The ring of polynomials in finitely many variables is of finitely presentation. -/
...
begin
  ...
  suffices hinj : function.injective (alg_hom.to_ring_hom (alg_equiv.to_alg_hom equiv.symm)),
