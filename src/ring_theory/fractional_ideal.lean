...
begin
  ...
  { ext, split, repeat {intro hx},
    { ext,
      ...
      { simp only [linear_map.mem_ker, coe_span_singleton, coe_mul, eq_self_iff_true, linear_map.coe_mk, or_false, ne.def,
          subtype.val_eq_coe, mul_eq_zero, coe_eq_zero] at *,
        exact hx },
