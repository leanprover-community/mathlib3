...
variables (R : Type*) [comm_ring R] {ι : Type*} [decidable_eq ι]
variables (A : ι → submodule R R)
variables [Π (i : ι) (x : A i), decidable (x ≠ 0)]
...
/--Equivalently, a homogeneous ideal is an `I : ideal R` such that `I` is generated by
...
lemma is_homogeneous_ideal.mem_iff
...
variables [linear_ordered_cancel_add_comm_monoid ι] [graded_algebra A]
variable [Π (I : homogeneous_ideal R A) (x : R),
