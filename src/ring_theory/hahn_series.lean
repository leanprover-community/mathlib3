...
variables (Γ) (R) [strict_ordered_add_cancel_semiring Γ] [nontrivial Γ]
/-- Casts a power series as a Hahn series with coefficients
  from an `strict_ordered_add_cancel_semiring`. -/
...
variables (Γ) (R) [strict_ordered_add_cancel_semiring Γ] [nontrivial Γ]
/-- Casting a power series as a Hahn series with coefficients
  from an `strict_ordered_add_cancel_semiring` is an algebra homomorphism. -/
