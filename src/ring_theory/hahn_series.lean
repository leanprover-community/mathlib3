...
variables (Γ) (R) [ordered_cancel_semiring Γ] [nontrivial Γ]

/-- Casts a power series as a Hahn series with coefficients from an `ordered_cancel_semiring`. -/
...
variables (Γ) (R) [ordered_cancel_semiring Γ] [nontrivial Γ]
/-- Casting a power series as a Hahn series with coefficients from an `ordered_cancel_semiring`
