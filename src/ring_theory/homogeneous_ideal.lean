...
private lemma homogeneous_ideal_iff_homogeneous_ideal'' (I : ideal (⨁ i, A i)) :
...
private lemma homogeneous_ideal''_iff_homogeneous_ideal' (I : ideal (⨁ i, A i)) :
  homogeneous_ideal'' I ↔ homogeneous_ideal' I :=
⟨λ HI, begin
...
lemma homogeneous_ideal.equivalent_definition (I : ideal (⨁ i, A i)) :
