...
/-- Equivalently, an `I : ideal (⨁ i, A i)` is homogeneous iff `I` is spaned by some set of
homogeneous element in `⨁ i, A i`-/
def homogeneous_ideal'' [add_comm_monoid ι] [gcomm_semiring A] (I : ideal (⨁ i, A i)) : Prop :=
  ∃ S, (∀ s ∈ S, is_homogeneous_element s) ∧ I = ideal.span S

open_locale pointwise

private lemma homogeneous_ideal_iff_homogeneous_ideal'' [add_comm_monoid ι] [gcomm_semiring A]
  (I : ideal (⨁ i, A i)) :
...
private lemma homogeneous_ideal''_iff_homogeneous_ideal' [add_comm_monoid ι] [gcomm_semiring A]
  (I : ideal (⨁ i, A i)) :
  homogeneous_ideal'' I ↔ homogeneous_ideal' I :=
⟨λ HI, begin
...
lemma homogeneous_ideal.equivalent_definition [add_comm_monoid ι] [gcomm_semiring A]
  (I : ideal (⨁ i, A i)) :
