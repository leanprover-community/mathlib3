...
begin
  ...
  delta finset.sum at hf,
  have := pow_sum_mem_span_pow (f.support.1.map (λ a, f a * a)) n,
  rw [hf, one_pow] at this,
  refine (span_le).mpr _ this,
  rintros _ hx,
  simp_rw [finset.mem_coe, multiset.mem_to_finset, multiset.mem_map] at hx,
  rcases hx with ⟨_, ⟨x, hx, rfl⟩, rfl⟩,
