...
-- can be moved to order/bounded_lattice.lean, after `ne_bot_of_gt`
lemma ne_bot_of_ne_bot_le {i j : α} [order_bot α] (h : i ≤ j) (hi : i ≠ ⊥) : j ≠ ⊥ :=
((bot_lt_iff_ne_bot.2 hi).trans_le h).ne'
