...
⟨p.map $ algebra_map R A, hp.map _,
  by rw [← aeval_def, ← aeval_apply_of_tower, aeval_def, hpx]⟩
...
begin
  ...
  rintros ⟨f, hf, hx⟩,
  use [f, hf],
  exact aeval_eq_zero_of_aeval_algebra_map_eq_zero_of_injective R A B hAB hx,
end
...
begin
  ...
  { rcases hr with ⟨p, hmp, hpr⟩,
    ...
    erw [← aeval_def, aeval_apply_of_tower _ R, map_restriction, aeval_def, hpr] },
