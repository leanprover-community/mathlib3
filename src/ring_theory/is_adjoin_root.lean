...
open adjoin_root is_adjoin_root
...
begin
  haveI := is_domain_of_prime (minpoly.prime_of_is_integrally_closed hx'),
  haveI := no_zero_smul_divisors_of_prime_of_degree_ne_zero (ne_of_lt (minpoly.degree_pos hx')),
  rw [← power_basis.minpoly_gen_eq, algebra.adjoin.power_basis', power_basis.minpoly_gen_map,
    power_basis.minpoly_gen_eq, power_basis'_gen,
    ← is_adjoin_root_monic_root_eq_root _ (minpoly.monic hx'), is_adjoin_root_monic.minpoly_eq],
