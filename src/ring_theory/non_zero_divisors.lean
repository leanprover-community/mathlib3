...
def non_zero_divisors (R : Type*) [comm_ring R] : submonoid R :=
...
lemma le_non_zero_divisors_of_domain {K : Type*} [integral_domain K] {M : submonoid K}
  (hM : ↑0 ∉ M) : M ≤ non_zero_divisors K :=
