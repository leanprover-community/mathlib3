...
begin
  ...
  have h1 : C c * C d * p = @integer_normalization _ _ _ _ _ f a * @integer_normalization _ _ _ _ _ f b,
  ...
  rw [← ring_hom.map_mul, eq_comm, (@integer_normalization _ _ _ _ _ f a).eq_C_content_mul_prim_part,
