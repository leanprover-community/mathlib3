...
begin
  ...
  { rw [cyclotomic_eq_geom_sum p, geom_sum_X_comp_X_add_one_eq_sum, ← lcoeff_apply,
      linear_map.map_sum],
  ...
  { rw [coeff_zero_eq_eval_zero, eval_comp, cyclotomic_eq_geom_sum p, eval_add, eval_X,
