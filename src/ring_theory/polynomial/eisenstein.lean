...
variables [algebra K L] [algebra R L] [algebra R K] [smul_assoc_class R K L] [is_separable K L]
...
open is_integrally_closed power_basis nat polynomial smul_assoc_class
