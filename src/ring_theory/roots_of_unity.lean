...
* `is_primitive_root.zmod_equiv_gpowers`: `zmod k` is equivalent to the subgroup generated by
...
variables {M N G G₀ R : Type*}
variables [comm_monoid M] [comm_monoid N] [comm_group G] [comm_group_with_zero G₀] [integral_domain R]
