...
begin
  ...
  simv only [witt_zero, witt_structure_rat, bind₁, aeval_zero',
...
begin
  apply mv_polynomial.map_injective (int.cast_ring_hom ℚ) int.cast_injective,
  simv only [witt_one, witt_structure_rat, X_in_terms_of_W_zero, alg_hom.map_one,
...
begin
  apply mv_polynomial.map_injective (int.cast_ring_hom ℚ) int.cast_injective,
  simv only [witt_one, witt_structure_rat, ring_hom.map_zero, alg_hom.map_one,
    ring_hom.map_one, map_witt_structure_int],
  revert hn, apply nat.strong_induction_on n, clear n,
  intros n IH hn,
  rw X_in_terms_of_W_eq,
  simv only [alg_hom.map_mul, alg_hom.map_sub, alg_hom.map_sum, alg_hom.map_pow,
    bind₁_X_right, bind₁_C_right],
  rw [sub_mul, one_mul],
  rw [finset.sum_eq_single 0],
  { simv only [inv_of_eq_inv, one_mul, inv_pow, tsub_zero, ring_hom.map_one, pow_zero],
    simv only [one_pow, one_mul, X_in_terms_of_W_zero, sub_self, bind₁_X_right] },
  { intros i hin hi0,
...
begin
  apply mv_polynomial.map_injective (int.cast_ring_hom ℚ) int.cast_injective,
  simv only [witt_add, witt_structure_rat, alg_hom.map_add, ring_hom.map_add,
...
begin
  apply mv_polynomial.map_injective (int.cast_ring_hom ℚ) int.cast_injective,
  simv only [witt_sub, witt_structure_rat, alg_hom.map_sub, ring_hom.map_sub,
    rename_X, X_in_terms_of_W_zero, map_X,
     witt_polynomial_zero, bind₁_X_right, map_witt_structure_int],
end
...
begin
  apply mv_polynomial.map_injective (int.cast_ring_hom ℚ) int.cast_injective,
  simv only [witt_mul, witt_structure_rat, rename_X, X_in_terms_of_W_zero, map_X,
...
begin
  apply mv_polynomial.map_injective (int.cast_ring_hom ℚ) int.cast_injective,
  simv only [witt_neg, witt_structure_rat, rename_X, X_in_terms_of_W_zero, map_X,
...
begin
  ...
  simv only [add_zero, ring_hom.map_add, constant_coeff_X],
end
...
begin
  apply constant_coeff_witt_structure_int p _ _ n,
  simv only [sub_zero, ring_hom.map_sub, constant_coeff_X],
end
...
begin
  apply constant_coeff_witt_structure_int p _ _ n,
  simv only [mul_zero, ring_hom.map_mul, constant_coeff_X],
end
...
begin
  apply constant_coeff_witt_structure_int p _ _ n,
  simv only [neg_zero, ring_hom.map_neg, constant_coeff_X],
end
...
begin
  apply constant_coeff_witt_structure_int p _ _ n,
  simv only [smul_zero, map_nsmul, constant_coeff_X],
end
...
begin
  apply constant_coeff_witt_structure_int p _ _ n,
  simv only [smul_zero, map_zsmul, constant_coeff_X],
end
...
by simv [has_neg.neg, eval, matrix.cons_fin_one]

lemma nsmul_coeff (m : ℕ) (x : 𝕎 R) (n : ℕ) :
  (m • x).coeff n = peval (witt_nsmul p m n) ![x.coeff] :=
by simv [has_smul.smul, eval, matrix.cons_fin_one]
