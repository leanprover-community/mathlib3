...
begin
  ...
  try { have h := ordinal.typein_lt_type (ordinal.out (0:ordinal)).r i,
    rw ordinal.type_out' at h,
    have hcontra := ordinal.zero_le (ordinal.typein (ordinal.out (0:ordinal)).r i),
...
begin
  ...
  { rw [add_move_left_inr,
    ...
    have h' : ∃ i : G.left_moves, (Grundy_value $ impartial_move_left_impartial hG i) =
      ordinal.typein (ordinal.out $ Grundy_value hG).r i₂,
    { have hlt : ordinal.typein (ordinal.out $ Grundy_value hG).r i₂ <
        ordinal.type (ordinal.out $ Grundy_value hG).r :=
      ...
      intros i₂ hlt,
      have hnotin :
        ordinal.typein (ordinal.out (ordinal.omin
