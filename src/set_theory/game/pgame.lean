...
instance is_empty_add_left_moves (x y : pgame) [is_empty x.left_moves] [is_empty y.left_moves] :
  is_empty (x + y).left_moves :=
begin
...
instance is_empty_add_right_moves (x y : pgame) [is_empty x.right_moves] [is_empty y.right_moves] :
