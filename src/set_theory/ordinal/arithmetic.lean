...
theorem one_lt_iff {a : ordinal} : 1 < a ↔ a ≠ 0 ∧ a ≠ 1 :=
by { rw ←not_iff_not, simp [le_one_iff, not_and_distrib] }
...
theorem div_pos_iff {a b : ordinal} (b0 : b ≠ 0) : 0 < a / b ↔ b ≤ a :=
by rw [←one_le_iff_pos, le_div b0, mul_one]
