...
protected theorem equiv.refl {n} (a : resp n) : resp.equiv a a := a.2

protected theorem equiv.euc : Π {n} {a b c : resp n}, equiv a b → equiv c b → equiv a c
| 0     a b c hab hcb := pSet.equiv.euc hab hcb
