...
-/
meta def check_univs (d : declaration) : tactic (option string) :=
-- autogenerated subproof declarations can and may contain "bad" universe parameters
if d.to_name.last.starts_with "_proof_" then return none else do
