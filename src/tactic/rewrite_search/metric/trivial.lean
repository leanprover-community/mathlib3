...
/-!
# The trivial metric reports that every vertex is distance zero from every other.
-/
...
meta def trivial_init_bound (_ : search_state α unit unit δ) (l r : vertex) :
bound_progress unit := bound_progress.exactly 0 ()
meta def trivial_improve_estimate_over (_ : search_state α unit unit δ) (m : dnum)
(l r : vertex) (bnd : bound_progress unit) : bound_progress unit := bound_progress.exactly 0 ()
