...
`specialize'` is a variant of `specialize`, the only difference being the order of the goals
generated by any underscores used. That is, `specialize'` puts goals from underscores first.
-/
