...
@[to_additive continuous.add_submonoid]
instance continuous.submonoid (α : Type u) (β : Type v) [topological_space α] [topological_space β]
...
@[to_additive continuous.add_subgroup]
instance continuous.subgroup (α : Type u) (β : Type v) [topological_space α] [topological_space β]
...
{ inv_mem := λ f fc, continuous.comp (topological_group.continuous_inv β) fc,
  ..continuous.submonoid α β, }.

@[to_additive continuous.add_monoid]
...
@[to_additive continuous.add_group]
...
instance continuous.subring (α : Type u) (β : Type v) [topological_space α] [topological_space β]
  [ring β] [topological_ring β] : is_subring { f : α → β | continuous f } :=
{ ..continuous.add_subgroup α β,
  ..continuous.submonoid α β }.
...
@subtype.ring _ _ _ (continuous.subring α β) -- infer_instance doesn't work?!
...
@subtype.comm_ring _ _ _ (continuous.subring α β) -- infer_instance doesn't work?!
