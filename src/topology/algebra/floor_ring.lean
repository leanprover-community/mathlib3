...
lemma tendsto_floor_right' [order_closed_topology α] (n : ℤ) :
  tendsto (λ x, floor x : α → α) (𝓝ᵣ n) (𝓝 n) :=
begin
...
lemma tendsto_ceil_left' [order_closed_topology α] (n : ℤ) :
  tendsto (λ x, ceil x : α → α) (𝓝ₗ n) (𝓝 n) :=
begin
...
lemma tendsto_floor_right [order_closed_topology α] (n : ℤ) :
  tendsto (λ x, floor x : α → α) (𝓝ᵣ n) (𝓝ᵣ n) :=
...
lemma tendsto_ceil_left [order_closed_topology α] (n : ℤ) :
  tendsto (λ x, ceil x : α → α) (𝓝ₗ n) (𝓝ₗ n) :=
...
lemma tendsto_floor_left [order_closed_topology α] (n : ℤ) :
  tendsto (λ x, floor x : α → α) (𝓝ₗ' n) (𝓝ₗ (n-1)) :=
begin
...
lemma tendsto_ceil_right [order_closed_topology α] (n : ℤ) :
  tendsto (λ x, ceil x : α → α) (𝓝ᵣ' n) (𝓝ᵣ (n+1)) :=
begin
...
lemma tendsto_floor_left' [order_closed_topology α] (n : ℤ) :
  tendsto (λ x, floor x : α → α) (𝓝ₗ' n) (𝓝 (n-1)) :=
begin
  rw ← nhds_within_univ,
...
lemma tendsto_ceil_right' [order_closed_topology α] (n : ℤ) :
  tendsto (λ x, ceil x : α → α) (𝓝ᵣ' n) (𝓝 (n+1)) :=
begin
  rw ← nhds_within_univ,
...
lemma tendsto_fract_left' [order_closed_topology α] [topological_add_group α]
  (n : ℤ) : tendsto (fract : α → α) (𝓝ₗ' n) (𝓝 1) :=
begin
...
lemma tendsto_fract_left [order_closed_topology α] [topological_add_group α]
  (n : ℤ) : tendsto (fract : α → α) (𝓝ₗ' n) (𝓝ₗ' 1) :=
...
lemma tendsto_fract_right' [order_closed_topology α] [topological_add_group α]
  (n : ℤ) : tendsto (fract : α → α) (𝓝ᵣ n) (𝓝 0) :=
begin
...
lemma tendsto_fract_right [order_closed_topology α] [topological_add_group α]
  (n : ℤ) : tendsto (fract : α → α) (𝓝ᵣ n) (𝓝ᵣ 0) :=
tendsto_nhds_within_of_tendsto_nhds_of_eventually_within _
