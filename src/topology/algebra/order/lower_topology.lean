...
instance [p : preorder α] : preorder (with_lower_topology) := p
instance [p : nonempty α] : nonempty (with_lower_topology) := p
instance [p : inhabited α] : inhabited (with_lower_topology) := p

/-- `to_with_lower_topology` is the identity function to the `with_lower_topology` of a type.  -/
@[pattern] def to_with_lower_topology : α ≃ with_lower_topology := equiv.refl _

/-- `of_with_lower_topology` is the identity function from the `with_lower_topology` of a type.  -/
@[pattern] def of_with_lower_topology : with_lower_topology ≃ α := equiv.refl _

@[simp] lemma to_with_lower_topology_symm_eq : (@to_with_lower_topology α).symm =
  of_with_lower_topology := rfl
@[simp] lemma of_with_lower_topology_symm_eq : (@of_with_lower_topology α).symm =
  to_with_lower_topology := rfl
...
instance : topological_space (@with_lower_topology α) := lower_topology
