...
lemma filter.tendsto.extend_compl_single [∀ i, topological_space (π i)] [decidable_eq ι]
...
lemma continuous_at.extend_compl_single [∀ i, topological_space (π i)] [decidable_eq ι]
...
hf.extend_compl_single hg

@[continuity] lemma continuous.extend_compl_single [∀ i, topological_space (π i)] [decidable_eq ι]
...
continuous_iff_continuous_at.2 $ λ x, hf.continuous_at.extend_compl_single hg.continuous_at
