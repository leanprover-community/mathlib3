...
variables [normed_add_group β] {𝕜 : Type*} [normed_field 𝕜] [normed_space 𝕜 β]
...
noncomputable instance : normed_add_group C₀(α, β) :=
normed_add_group.induced to_bcf_add_monoid_hom (to_bcf_injective α β)
...
{ norm_mul := λ f g, norm_mul_le f.to_bcf g.to_bcf,
  ...
  ..zero_at_infty_continuous_map.normed_add_group }
...
variables [normed_add_group β] [star_add_monoid β] [normed_star_group β]
