...
lemma complete (e : α ≃ᵢ β) (hF : complete_space β) : complete_space α :=
...
lemma complete_iff (e : α ≃ᵢ β) : complete_space α ↔ complete_space β :=
⟨λ h, e.symm.complete h, λ h, e.complete h⟩
