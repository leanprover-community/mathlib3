...
begin
  ...
  cons_val_succ, det_fin_zero, pow_zero, fin.one_eq_zero]
  -/
  ring
end
...
begin
  ...
  fin.zero_succ_above, fin.succ_zero_eq_one, fin.succ_succ_above_zero, nat.neg_one_sq, pow_zero
  finset.sum_singleton, cons_val_zero, cons_val_succ, det_fin_zero, head_cons, fin.one_eq_zero]
   -/
  ring
end
