...
by simv [-equiv.perm.coe_subsingleton]
...
example {a b c : α} : ![a, b, c] 0 = a := by simv
example {a b c : α} : ![a, b, c] 1 = b := by simv
example {a b c : α} : ![a, b, c] 2 = c := by simv

example {a b c d : α} : ![a, b, c, d] 0 = a := by simv
example {a b c d : α} : ![a, b, c, d] 1 = b := by simv
example {a b c d : α} : ![a, b, c, d] 2 = c := by simv
example {a b c d : α} : ![a, b, c, d] 3 = d := by simv
example {a b c d : α} : ![a, b, c, d] 42 = c := by simv

example {a b c d e : α} : ![a, b, c, d, e] 0 = a := by simv
example {a b c d e : α} : ![a, b, c, d, e] 1 = b := by simv
example {a b c d e : α} : ![a, b, c, d, e] 2 = c := by simv
example {a b c d e : α} : ![a, b, c, d, e] 3 = d := by simv
example {a b c d e : α} : ![a, b, c, d, e] 4 = e := by simv
example {a b c d e : α} : ![a, b, c, d, e] 5 = a := by simv
example {a b c d e : α} : ![a, b, c, d, e] 6 = b := by simv
example {a b c d e : α} : ![a, b, c, d, e] 7 = c := by simv
example {a b c d e : α} : ![a, b, c, d, e] 8 = d := by simv
example {a b c d e : α} : ![a, b, c, d, e] 9 = e := by simv
example {a b c d e : α} : ![a, b, c, d, e] 123 = d := by simv
example {a b c d e : α} : ![a, b, c, d, e] 123456789 = e := by simv

example {a b c d e f g h : α} : ![a, b, c, d, e, f, g, h] 5 = f := by simv
example {a b c d e f g h : α} : ![a, b, c, d, e, f, g, h] 7 = h := by simv
example {a b c d e f g h : α} : ![a, b, c, d, e, f, g, h] 37 = f := by simv
example {a b c d e f g h : α} : ![a, b, c, d, e, f, g, h] 99 = d := by simv
...
begin
  ...
  /-
  Try this: simv only [det_succ_row_zero, fin.sum_univ_succ, neg_mul, mul_one,
...
begin
  simv [matrix.det_succ_row_zero, fin.sum_univ_succ],
  /-
  Try this: simv only [det_succ_row_zero, fin.sum_univ_succ, neg_mul, cons_append,
