...
/-!
Test if `simv` can use a lemma about `pi.has_one` to simplify `1` coming from `pi.group`
-/
...
example [inhabited I] [Π i, group (f i)] (F : Π i, f i) : eval_default (F⁻¹ * F) = 1 := by simv
