...
" ["ff", "int", "[var0, var1]", "[(((3 * var0) + (2 * var1)) - 10)]", "(((3 * var0) + (2 * var1)) - 10)"] "linear_combination h1"


example (x y : ℚ) (h1 : x*y + 2*x = 1) (h2 : x = y) :
  x*y = -2*y + 1 :=
by test_polyrith  "(poly.const 1/1) (poly.sub (poly.const 0/1) (poly.const 2/1))
" ["ff", "rat", "[var0, var1]", "[(((var0 * var1) + (2 * var0)) - 1), (var0 - var1)]", "((var0 * var1) - (((-1 * 2) * var1) + 1))"]  "linear_combination h1 - 2 * h2"

example (x y : ℝ) (h1 : x + 2 = -3) (h2 : y = 10) :
  -y + 2*x + 4 = -16 :=
by test_polyrith  "(poly.const 2/1) (poly.sub (poly.const 0/1) (poly.const 1/1))
" ["ff", "real", "[var0, var1]", "[((var1 + 2) - (-1 * 3)), (var0 - 10)]", "((((-1 * var0) + (2 * var1)) + 4) - (-1 * 16))"]  "linear_combination 2 * h1 - h2"

example (x y z : ℝ) (ha : x + 2*y - z = 4) (hb : 2*x + y + z = -2)
    (hc : x + 2*y + z = 2) :
  -3*x - 3*y - 4*z = 2 :=
by test_polyrith  "(poly.const 1/1) (poly.sub (poly.const 0/1) (poly.const 1/1)) (poly.sub (poly.const 0/1) (poly.const 2/1))
" ["ff", "real", "[var0, var1, var2]", "[(((var0 + (2 * var1)) - var2) - 4), ((((2 * var0) + var1) + var2) - (-1 * 2)), (((var0 + (2 * var1)) + var2) - 2)]", "(((((-1 * 3) * var0) - (3 * var1)) - (4 * var2)) - 2)"]  "linear_combination ha - hb - 2 * hc"

example (w x y z : ℝ) (h1 : x + 2.1*y + 2*z = 2) (h2 : x + 8*z + 5*w = -6.5)
    (h3 : x + y + 5*z + 5*w = 3) :
  x + 2.2*y + 2*z - 5*w = -8.5 :=
by test_polyrith  "(poly.const 2/1) (poly.const 1/1) (poly.sub (poly.const 0/1) (poly.const 2/1))
" ["ff", "real", "[var0, var1, var2, var3]", "[(((var0 + (21/10 * var1)) + (2 * var2)) - 2), (((var0 + (8 * var2)) + (5 * var3)) - (-1 * 13/2)), ((((var0 + var1) + (5 * var2)) + (5 * var3)) - 3)]", "((((var0 + (11/5 * var1)) + (2 * var2)) - (5 * var3)) - (-1 * 17/2))"]  "linear_combination 2 * h1 + h2 - 2 * h3"
...
" ["ff", "rat", "[var0, var1, var2, var3]", "[(var0 - 4), (3 - var3), ((var1 * 3) - var2), ((-1 * var2) - var0)]", "(((((2 * var0) - 3) + (9 * var1)) + (3 * var2)) - (((8 - var3) + (3 * var2)) - (3 * var0)))"]  "linear_combination 2 * h1 - h2 + 3 * h3 - 3 * h4"
...
example («¥» y : ℤ) (h1 : 3*«¥» + 2*y = 10):
  «¥» * (3*«¥» + 2*y) = 10 * «¥» :=
by test_polyrith  "(poly.var 0)
" ["ff", "int", "[var0, var1]", "[(((3 * var0) + (2 * var1)) - 10)]", "((var0 * ((3 * var0) + (2 * var1))) - (10 * var0))"]  "linear_combination «¥» * h1"
...
example (a b : ℤ) (h : a = b) :
  a * a = a * b :=
by test_polyrith  "(poly.var 0)
" ["ff", "int", "[var0, var1]", "[(var0 - var1)]", "((var0 * var0) - (var0 * var1))"]  "linear_combination a * h"

example (a b c : ℤ) (h : a = b) :
  a * c = b * c :=
by test_polyrith  "(poly.var 1)
" ["ff", "int", "[var0, var1, var2]", "[(var0 - var2)]", "((var0 * var1) - (var2 * var1))"]  "linear_combination c * h"

example (a b c : ℤ) (h1 : a = b) (h2 : b = 1) :
  c * a + b = c * b + 1 :=
by test_polyrith  "(poly.var 0) (poly.const 1/1)
" ["ff", "int", "[var0, var1, var2]", "[(var1 - var2), (var2 - 1)]", "(((var0 * var1) + var2) - ((var0 * var2) + 1))"]  "linear_combination c * h1 + h2"

example (x y : ℚ) (h1 : x + y = 3) (h2 : 3*x = 7) :
  x*x*y + y*x*y + 6*x = 3*x*y + 14 :=
by test_polyrith  "(poly.sub (poly.sum (poly.pow (poly.var 0) 2) (poly.mul (poly.const 7/3) (poly.var 1))) (poly.const 49/9)) (poly.sum (poly.sum (poly.sub (poly.sub (poly.mul (poly.const 1/3) (poly.pow (poly.var 1) 2)) (poly.mul (poly.const 1/3) (poly.pow (poly.var 0) 2))) (poly.mul (poly.const 16/9) (poly.var 1))) (poly.mul (poly.const 2/9) (poly.var 0))) (poly.const 13/3))
" ["ff", "rat", "[var0, var1]", "[((var0 + var1) - 3), ((3 * var0) - 7)]", "(((((var0 * var0) * var1) + ((var1 * var0) * var1)) + (6 * var0)) - (((3 * var0) * var1) + 14))"]  "linear_combination (x ^ 2 + 7 / 3 * y - 49 / 9) * h1 + (1 / 3 * y ^ 2 - 1 / 3 * x ^ 2 - 16 / 9 * y + 2 / 9 * x +
    13 / 3) * h2"

example (x y z w : ℚ) (hzw : z = w) : x*z + 2*y*z = x*w + 2*y*w :=
by test_polyrith  "(poly.sum (poly.mul (poly.const 2/1) (poly.var 2)) (poly.var 0))
" ["ff", "rat", "[var0, var1, var2, var3]", "[(var1 - var3)]", "(((var0 * var1) + ((2 * var2) * var1)) - ((var0 * var3) + ((2 * var2) * var3)))"]  "linear_combination (2 * y + x) * hzw"
...
" ["ff", "real", "[var0, var1]", "[((2 * var1) - 4), ((2 * var0) - (var1 - var0))]", "(var0 - 2/3)"]  "linear_combination 1 / 6 * ha + 1 / 3 * hab"
...
" ["ff", "rat", "[var0, var1, var2, var3]", "[((var2 + var3) - 0), ((var0 + var1) - 0)]", "((((var0 + var1) + var2) + var3) - 0)"]  "linear_combination term c d + h"
...
" ["ff", "rat", "[var0, var1, var2]", "[(var0 - var2), (var1 - (2 * var1))]", "(((3 * var0) + var1) - ((3 * var2) + (2 * var1)))"]  "linear_combination 3 * h a b + hqc"

constant bad (q : ℚ) : q = 0

example (a b : ℚ) : a + b^3 = 0 :=
by test_polyrith [bad a, bad (b^2)] "(poly.const 1/1) (poly.var 1)
" ["ff", "rat", "[var0, var1]", "[(var0 - 0), ((var1 ^ 2) - 0)]", "((var0 + (var1 ^ 3)) - 0)"]  "linear_combination bad a + b * bad (b ^ 2)"

/-! ### Case over arbitrary field/ring -/

example {α} [h : comm_ring α] {a b c d e f : α} (h1 : a*d = b*c) (h2 : c*f = e*d) :
  c * (a*f - b*e) = 0 :=
by test_polyrith  "(poly.var 4) (poly.var 1)
" ["ff", "α", "[var0, var1, var2, var3, var4, var5]", "[((var1 * var5) - (var3 * var0)), ((var0 * var2) - (var4 * var5))]", "((var0 * ((var1 * var2) - (var3 * var4))) - 0)"]  "linear_combination e * h1 + a * h2"
...
begin
  ...
  { contrapose! hp_nonzero with hs_nonzero,
    test_polyrith  "(poly.const 0/1) (poly.const 0/1) (poly.sub (poly.const 0/1) (poly.const 1/1)) (poly.const 0/1) (poly.var 4)
" ["ff", "K", "[var0, var1, var2, var3, var4, var5]", "[((var1 ^ 2) - ((var2 ^ 2) + (var0 ^ 3))), ((var3 ^ 3) - (var2 + var1)), ((var4 * var3) - var0), (((1 + var5) + (var5 ^ 2)) - 0), (var3 - 0)]", "(var0 - 0)"]  "linear_combination -ht + t * hs_nonzero"
     },
  have H' : 2 * q = s ^ 3 - t ^ 3,
  { rw ← mul_left_inj' (pow_ne_zero 3 hs_nonzero),
    test_polyrith  "(poly.sub (poly.const 0/1) (poly.const 1/1)) (poly.sum (poly.sub (poly.sub (poly.const 0/1) (poly.pow (poly.var 1) 3)) (poly.var 3)) (poly.var 0)) (poly.sum (poly.sum (poly.mul (poly.pow (poly.var 2) 2) (poly.pow (poly.var 1) 2)) (poly.mul (poly.mul (poly.var 4) (poly.var 2)) (poly.var 1))) (poly.pow (poly.var 4) 2)) (poly.const 0/1)
" ["ff", "K", "[var0, var1, var2, var3, var4, var5]", "[((var3 ^ 2) - ((var0 ^ 2) + (var4 ^ 3))), ((var1 ^ 3) - (var0 + var3)), ((var2 * var1) - var4), (((1 + var5) + (var5 ^ 2)) - 0)]", "(((2 * var0) * (var1 ^ 3)) - (((var1 ^ 3) - (var2 ^ 3)) * (var1 ^ 3)))"]  "linear_combination -hr + (-s ^ 3 - r + q) * hs3 + (t ^ 2 * s ^ 2 + p * t * s + p ^ 2) * ht"
  },
test_polyrith  "(poly.const 0/1) (poly.const 0/1) (poly.sum (poly.sum (poly.sub (poly.sum (poly.sub (poly.sum (poly.sum (poly.sub (poly.mul (poly.pow (poly.var 5) 4) (poly.var 4)) (poly.mul (poly.pow (poly.var 5) 4) (poly.var 3))) (poly.mul (poly.pow (poly.var 5) 4) (poly.var 0))) (poly.mul (poly.pow (poly.var 5) 3) (poly.var 4))) (poly.mul (poly.pow (poly.var 5) 3) (poly.var 3))) (poly.mul (poly.pow (poly.var 5) 2) (poly.var 4))) (poly.mul (poly.pow (poly.var 5) 2) (poly.var 3))) (poly.mul (poly.const 3/1) (poly.mul (poly.pow (poly.var 5) 2) (poly.var 0)))) (poly.mul (poly.const 2/1) (poly.mul (poly.var 5) (poly.var 0)))) (poly.sum (poly.sum (poly.sub (poly.sub (poly.sub (poly.sum (poly.sum (poly.sub (poly.sub (poly.sub (poly.sum (poly.sum (poly.sub (poly.const 0/1) (poly.mul (poly.var 5) (poly.pow (poly.var 4) 3))) (poly.mul (poly.var 5) (poly.pow (poly.var 3) 3))) (poly.mul (poly.mul (poly.pow (poly.var 5) 2) (poly.var 4)) (poly.var 1))) (poly.mul (poly.mul (poly.pow (poly.var 5) 2) (poly.var 3)) (poly.var 1))) (poly.mul (poly.mul (poly.var 5) (poly.pow (poly.var 4) 2)) (poly.var 0))) (poly.mul (poly.mul (poly.var 5) (poly.pow (poly.var 3) 2)) (poly.var 0))) (poly.mul (poly.mul (poly.pow (poly.var 5) 2) (poly.var 1)) (poly.var 0))) (poly.pow (poly.var 4) 3)) (poly.pow (poly.var 3) 3)) (poly.mul (poly.mul (poly.var 5) (poly.var 1)) (poly.var 0))) (poly.mul (poly.var 4) (poly.pow (poly.var 0) 2))) (poly.mul (poly.var 3) (poly.pow (poly.var 0) 2))) (poly.mul (poly.const 3/1) (poly.mul (poly.var 1) (poly.var 0)))) (poly.sub (poly.const 0/1) (poly.const 1/1))
" ["ff", "K", "[var0, var1, var2, var3, var4, var5, var6]", "[((var6 ^ 2) - ((var2 ^ 2) + (var1 ^ 3))), ((var3 ^ 3) - (var2 + var6)), ((var4 * var3) - var1), (((1 + var5) + (var5 ^ 2)) - 0), ((2 * var2) - ((var3 ^ 3) - (var4 ^ 3)))]", "((((var0 ^ 3) + ((3 * var1) * var0)) - (2 * var2)) - (((var0 - (var3 - var4)) * (var0 - ((var3 * var5) - (var4 * (var5 ^ 2))))) * (var0 - ((var3 * (var5 ^ 2)) - (var4 * var5)))))"]  "linear_combination (ω ^ 4 * t - ω ^ 4 * s + ω ^ 4 * x + ω ^ 3 * t - ω ^ 3 * s + ω ^ 2 * t - ω ^ 2 * s +
      3 * (ω ^ 2 * x) +
