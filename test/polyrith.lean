...
example («¥» y : ℤ) (h1 : 3*«¥» + 2*y = 10):
  «¥» * (3*«¥» + 2*y) = 10 * «¥» :=
by test_polyrith
  "{\"data\":{\"coeffs\":[\"(poly.var 0)\"],\"power\":1},\"success\":true}"
  ["ff",
  "int",
  "2",
  "[(((3 * var0) + (2 * var1)) - 10)]",
...
example (a b c : ℤ) (h1 : a = b) (h2 : b = 1) :
  c * a + b = c * b + 1 :=
by test_polyrith
  "{\"data\":{\"coeffs\":[\"(poly.var 0)\",\"(poly.const 1/1)\"],\"power\":1},\"success\":true}"
  ["ff",
  "int",
  "3",
  "[(var1 - var2), (var2 - 1)]",
...
by test_polyrith
  "{\"data\":{\"coeffs\":[\"(poly.mul (poly.var 0) (poly.var 1))\",\"(poly.const 2/1)\"],\"power\":1},\"success\":true}"
  ["ff",
  "rat",
  "2",
...
by test_polyrith
  "{\"data\":{\"coeffs\":[\"(poly.add (poly.var 0) (poly.mul (poly.const 2/1) (poly.var 2)))\"],\"power\":1},\"success\":true}"
  ["ff",
  "rat",
  "4",
  "[(var1 - var3)]",
...
begin
  ...
  { rw ← mul_left_inj' (pow_ne_zero 3 hs_nonzero),
    test_polyrith
  "{\"data\":{\"coeffs\":[\"(poly.const -1/1)\",\"(poly.sub (poly.add (poly.neg (poly.pow (poly.var 1) 3)) (poly.var 0)) (poly.var 3))\",\"(poly.add (poly.add (poly.mul (poly.pow (poly.var 1) 2) (poly.pow (poly.var 2) 2)) (poly.mul (poly.mul (poly.var 1) (poly.var 2)) (poly.var 4))) (poly.pow (poly.var 4) 2))\",\"(poly.const 0/1)\"],\"power\":1},\"success\":true}"
  ["ff",
  "K",
  "6",
  ...
  "linear_combination (x * ω ^ 4 - s * ω ^ 4 + t * ω ^ 4 - s * ω ^ 3 + t * ω ^ 3 + 3 * x * ω ^ 2 - s * ω ^ 2 +
      t * ω ^ 2 +
    2 * x * ω) * ht + (-(x * s ^ 2 * ω) - x * t ^ 2 * ω + x * p * ω ^ 2 - p * s * ω ^ 2 + p * t * ω ^ 2 +
              x ^ 2 * s -
            x ^ 2 * t -
          x * p * ω +
        3 * x * p +
...
by test_polyrith
  ...
  "[((var0 + 1) - 2), ((var0 + 2) - 2)]",
  "(1 - 2)"]
  "linear_combination -h1 + h2 with {exponent := 0}"
