...
example {a b : ℤ} (h : b ≤ a) : 0 ≤ a - b := by positivity
example {a b : ℤ} (h : a ≠ b) : a - b ≠ 0 := by positivity
example {a b : ℤ} (h : b ≠ a) : a - b ≠ 0 := by positivity
example {a b : ℤ} (h₀ : b ≠ a) (h₁ : b ≤ a) : 0 < a - b := by positivity
example {a b : ℤ} (h₀ : a ≠ b) (h₁ : b ≤ a) : 0 < a - b := by positivity
