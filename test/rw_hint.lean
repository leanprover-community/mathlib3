...
Try this: rw ordered_cancel_comm_monoid.add_assoc
Try this: rw norm_num.mul_bit0
Try this: rw comm_semiring.right_distrib
Try this: rw add_assoc
Try this: rw two_mul
Try this: rw add_monoid.add_zero
Try this: rw add_left_cancel_semigroup.add_assoc
Try this: rw right_distrib
Try this: rw comm_semiring.add_assoc
Try this: rw nat_add_zero
Try this: rw nat.succ_mul_succ_eq
Try this: rw bit1.equations._eqn_1
Try this: rw linear_ordered_semiring.add_assoc
Try this: rw add_zero
Try this: rw nat.bit0_val
Try this: rw comm_monoid.mul_comm
Try this: rw nat.succ.inj_eq
Try this: rw nat.add_right_comm
Try this: rw norm_num.add_comm_middle
Try this: rw distrib.right_distrib
...
Try this: rw add_right_cancel_semigroup.add_assoc
Try this: rw semiring.right_distrib
...
Try this: rw ordered_semiring.right_distrib
Try this: rw add_comm_monoid.add_assoc
Try this: rw nat.one_succ_zero
Try this: rw nat.bit0_succ_eq
Try this: rw decidable_linear_ordered_semiring.right_distrib
Try this: rw add_right_comm
Try this: rw decidable_linear_ordered_semiring.add_comm
Try this: rw nat.left_distrib
Try this: rw comm_semigroup.mul_comm
Try this: rw nat.right_distrib
Try this: rw linear_ordered_semiring.add_zero
Try this: rw decidable_linear_ordered_semiring.add_assoc
...
Try this: rw nat.has_one.equations._eqn_1
...
Try this: rw nat.has_mul.equations._eqn_1
Try this: rw nat.add_left_comm
Try this: rw add_comm_semigroup.add_comm
Try this: rw ordered_semiring.left_distrib
Try this: rw add_left_comm
Try this: rw norm_num.bit0_add_one
Try this: rw ordered_semiring.add_assoc
Try this: rw semiring.add_comm
Try this: rw linear_ordered_semiring.right_distrib
Try this: rw decidable_linear_ordered_cancel_comm_monoid.add_zero
Try this: rw distrib.left_distrib
Try this: rw semiring.add_assoc
Try this: rw decidable_linear_ordered_cancel_comm_monoid.add_assoc
Try this: rw bit0.equations._eqn_1
Try this: rw nat.add_assoc
Try this: rw mul_add
...
Try this: rw ←norm_num.add1_bit1
Try this: rw ←add_left_cancel_semigroup.add_assoc
...
Try this: rw ←norm_num.add1.equations._eqn_1
Try this: rw ←add_comm_monoid.add_assoc
...
Try this: rw ←norm_num.bit0_add_bit0
